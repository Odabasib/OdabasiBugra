CREATE TABLE [GUSTO00004].[IsMerkeziDagitim] (
...
CREATE INDEX [pAlanIsMerkezi]
  ON [GUSTO00004].[IsMerkeziDagitim] ([pAlanIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VerenIsMerkeziYilAy]
  ON [GUSTO00004].[IsMerkeziDagitim] ([pVerenIsMerkezi], [nYil], [nAy], [pAlanIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO