CREATE TABLE [GUSTO00003].[KKFMEABaslik] (
...
CREATE INDEX [lNo]
  ON [GUSTO00003].[KKFMEABaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHazirlayanBolum]
  ON [GUSTO00003].[KKFMEABaslik] ([pHazirlayanBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOnaylayanBolum]
  ON [GUSTO00003].[KKFMEABaslik] ([pOnaylayanBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSorumluBolum]
  ON [GUSTO00003].[KKFMEABaslik] ([pSorumluBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[KKFMEABaslik] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00003].[KKFMEABaslik] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO