CREATE TABLE [GUSTO00003].[StokGrupKodu] (
...
CREATE INDEX [sAd]
  ON [GUSTO00003].[StokGrupKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00003].[StokGrupKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyGrup]
  ON [GUSTO00003].[StokGrupKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyGrup]
  ON [GUSTO00003].[StokGrupKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO