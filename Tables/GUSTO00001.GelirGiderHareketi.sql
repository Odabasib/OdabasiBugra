CREATE TABLE [GUSTO00001].[GelirGiderHareketi] (
...
CREATE INDEX [HareketKey]
  ON [GUSTO00001].[GelirGiderHareketi] ([pHareketID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pButceKodu]
  ON [GUSTO00001].[GelirGiderHareketi] ([pButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00001].[GelirGiderHareketi] ([dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurTarihKey]
  ON [GUSTO00001].[GelirGiderHareketi] ([pGelirGiderTuruKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YerTarihKey]
  ON [GUSTO00001].[GelirGiderHareketi] ([pGelirGiderYeriKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO