CREATE TABLE [GUSTO00003].[SabitKYerKodu] (
...
CREATE INDEX [sAd]
  ON [GUSTO00003].[SabitKYerKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00003].[SabitKYerKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyDepo]
  ON [GUSTO00003].[SabitKYerKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyDepo]
  ON [GUSTO00003].[SabitKYerKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO