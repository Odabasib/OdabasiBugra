CREATE TABLE [GUSTO00001].[AlinanTeminatMektubu] (
...
CREATE INDEX [CariNo]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pCari], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariTarih]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pCari], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariVade]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pCari], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaNo]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pSCKasasi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarih]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pSCKasasi], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVade]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pSCKasasi], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDAlis]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pIslemIDAlis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sMektupNo]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([sMektupNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00001].[AlinanTeminatMektubu] ([dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO