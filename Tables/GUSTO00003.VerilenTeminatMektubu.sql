CREATE TABLE [GUSTO00003].[VerilenTeminatMektubu] (
...
CREATE INDEX [BankaNo]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([pBankaHesabi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariNo]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDVerilis]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([pIslemIDVerilis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([dtMektupTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00003].[VerilenTeminatMektubu] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO