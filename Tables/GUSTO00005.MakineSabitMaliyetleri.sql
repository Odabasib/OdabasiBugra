CREATE TABLE [GUSTO00005].[MakineSabitMaliyetleri] (
...
CREATE INDEX [cTur]
  ON [GUSTO00005].[MakineSabitMaliyetleri] ([pKod], [pOperasyonMakina])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDirekGiderKodu]
  ON [GUSTO00005].[MakineSabitMaliyetleri] ([pDirekGiderKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO