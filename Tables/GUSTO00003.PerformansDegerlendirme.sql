CREATE TABLE [GUSTO00003].[PerformansDegerlendirme] (
...
CREATE UNIQUE INDEX [PerformansTanimDonemPers]
  ON [GUSTO00003].[PerformansDegerlendirme] ([cDegerlendirmeTuru], [pPerformansTanimi], [pDegerlentirmeTuru], [pDegerlendirmeDonemi], [pPersonel], [pOrganizasyon], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO