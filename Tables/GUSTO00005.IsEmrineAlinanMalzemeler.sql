CREATE TABLE [GUSTO00005].[IsEmrineAlinanMalzemeler] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00005].[IsEmrineAlinanMalzemeler] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[IsEmrineAlinanMalzemeler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO