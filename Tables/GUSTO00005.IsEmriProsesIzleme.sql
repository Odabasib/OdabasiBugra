CREATE TABLE [GUSTO00005].[IsEmriProsesIzleme] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00005].[IsEmriProsesIzleme] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[IsEmriProsesIzleme] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[IsEmriProsesIzleme] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO