CREATE TABLE [GUSTO00004].[DigerOdemeTahsilat] (
...
CREATE INDEX [CariTurTarihKey]
  ON [GUSTO00004].[DigerOdemeTahsilat] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurSeriNoKey]
  ON [GUSTO00004].[DigerOdemeTahsilat] ([sKaynakTuru], [sSeri], [lNo], [pKaynakOdemePlani])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurTarihKey]
  ON [GUSTO00004].[DigerOdemeTahsilat] ([dtOdemeTarihi], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO