CREATE TABLE [GUSTO00003].[IsEmriFireOlanUrunler] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriFireOlanUrunler] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[IsEmriFireOlanUrunler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pStokHareketSatir]
  ON [GUSTO00003].[IsEmriFireOlanUrunler] ([pStokHareketSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO