CREATE TABLE [GUSTO00001].[PersonelAnketCevap] (
...
CREATE INDEX [BasvuruCevapKey]
  ON [GUSTO00001].[PersonelAnketCevap] ([pBasvuru], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelCevapKey]
  ON [GUSTO00001].[PersonelAnketCevap] ([pHesapKodu], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO