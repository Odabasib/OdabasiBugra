CREATE TABLE [GUSTO00001].[KontrolPlanKrkt] (
...
CREATE INDEX [cOrneklemeFrekansBirimi]
  ON [GUSTO00001].[KontrolPlanKrkt] ([cOrneklemeFrekansBirimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cOrneklemeFrekansTipi]
  ON [GUSTO00001].[KontrolPlanKrkt] ([cOrneklemeFrekansTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cToleransTipi]
  ON [GUSTO00001].[KontrolPlanKrkt] ([cToleransTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KontrolPlanKrk]
  ON [GUSTO00001].[KontrolPlanKrkt] ([pKontrolPlan], [pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKaliteKontrolYeri]
  ON [GUSTO00001].[KontrolPlanKrkt] ([pKaliteKontrolYeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00001].[KontrolPlanKrkt] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolPlan]
  ON [GUSTO00001].[KontrolPlanKrkt] ([pKontrolPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO