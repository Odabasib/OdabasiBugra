CREATE TABLE [GUSTO00001].[StdMaliyetBirimMaliyet] (
...
CREATE INDEX [pBaslik]
  ON [GUSTO00001].[StdMaliyetBirimMaliyet] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHesap]
  ON [GUSTO00001].[StdMaliyetBirimMaliyet] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00001].[StdMaliyetBirimMaliyet] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO