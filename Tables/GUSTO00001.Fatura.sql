CREATE TABLE [GUSTO00001].[Fatura] (
...
CREATE INDEX [Cari]
  ON [GUSTO00001].[Fatura] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaNo]
  ON [GUSTO00001].[Fatura] ([lFaturaNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaTarih]
  ON [GUSTO00001].[Fatura] ([dtFaturaTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FCariTur]
  ON [GUSTO00001].[Fatura] ([nEFaturaDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemId]
  ON [GUSTO00001].[Fatura] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemIdMaliye]
  ON [GUSTO00001].[Fatura] ([pIslemIDMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarihi]
  ON [GUSTO00001].[Fatura] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO