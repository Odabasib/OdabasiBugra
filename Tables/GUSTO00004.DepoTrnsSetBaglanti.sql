CREATE TABLE [GUSTO00004].[DepoTrnsSetBaglanti] (
...
CREATE INDEX [DepoTrnsBaslikSetStokKey]
  ON [GUSTO00004].[DepoTrnsSetBaglanti] ([pDepoHareketBaslik], [bDepoTransferEmri], [pSetKodu], [pStokKodu], [pIzlemeKodu], [pDepoHareket], [pBagliOlduguSatir], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO