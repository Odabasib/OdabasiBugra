CREATE TABLE [GUSTO00003].[EgitimAtama] (
...
CREATE INDEX [dtTarihpPlanpPersonel]
  ON [GUSTO00003].[EgitimAtama] ([dtTarih], [pPlan], [pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00003].[EgitimAtama] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPlan]
  ON [GUSTO00003].[EgitimAtama] ([pPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO