CREATE TABLE [GUSTO00003].[FaturaAltiMasraf] (
...
CREATE INDEX [FAMSiraKey]
  ON [GUSTO00003].[FaturaAltiMasraf] ([pFatura], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHizmetHareketi]
  ON [GUSTO00003].[FaturaAltiMasraf] ([pHizmetHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMasrafKodu]
  ON [GUSTO00003].[FaturaAltiMasraf] ([pMasrafKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO