CREATE TABLE [GUSTO00001].[PersonelKodu] (
...
CREATE INDEX [PK_sAdKey]
  ON [GUSTO00001].[PersonelKodu] ([sSoyad], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PK_UstKodAdKey]
  ON [GUSTO00001].[PersonelKodu] ([pUstKod], [sSoyad], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PK_UstKodKodKey]
  ON [GUSTO00001].[PersonelKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00001].[PersonelKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO