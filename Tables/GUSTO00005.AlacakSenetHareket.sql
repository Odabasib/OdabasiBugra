CREATE TABLE [GUSTO00005].[AlacakSenetHareket] (
...
CREATE UNIQUE INDEX [HareketSirasi]
  ON [GUSTO00005].[AlacakSenetHareket] ([pSenet], [nSiraNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00005].[AlacakSenetHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSenetBordrosu]
  ON [GUSTO00005].[AlacakSenetHareket] ([pSenetBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO