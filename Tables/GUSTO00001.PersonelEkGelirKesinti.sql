CREATE TABLE [GUSTO00001].[PersonelEkGelirKesinti] (
...
CREATE INDEX [EkGelirYilAyKey]
  ON [GUSTO00001].[PersonelEkGelirKesinti] ([pEkGelirKesinti], [pIkramiyeTanimi], [pIsyeri])
  ON [PRIMARY]
GO

CREATE INDEX [PersonelTipYilAyKey]
  ON [GUSTO00001].[PersonelEkGelirKesinti] ([pPersonel])
  ON [PRIMARY]
GO