CREATE TABLE [GUSTO00001].[StokYuruyenMaliyet] (
...
CREATE INDEX [StokDepoTarihKey]
  ON [GUSTO00001].[StokYuruyenMaliyet] ([pStokKarti], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokHareketKey]
  ON [GUSTO00001].[StokYuruyenMaliyet] ([pStokHareket], [pIzlemeKodu], [pDepoMaliyetKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO