CREATE TABLE [GUSTO00004].[IsEmrineAlinanMalzemeler] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00004].[IsEmrineAlinanMalzemeler] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[IsEmrineAlinanMalzemeler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO