CREATE TABLE [GUSTO00001].[TalepIsEmriBaglanti] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00001].[TalepIsEmriBaglanti] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriMalzemeler]
  ON [GUSTO00001].[TalepIsEmriBaglanti] ([pIsEmriMalzemeler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTalep]
  ON [GUSTO00001].[TalepIsEmriBaglanti] ([pTalep])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO