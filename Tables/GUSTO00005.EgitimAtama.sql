CREATE TABLE [GUSTO00005].[EgitimAtama] (
...
CREATE INDEX [dtTarihpPlanpPersonel]
  ON [GUSTO00005].[EgitimAtama] ([dtTarih], [pPlan], [pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00005].[EgitimAtama] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPlan]
  ON [GUSTO00005].[EgitimAtama] ([pPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO