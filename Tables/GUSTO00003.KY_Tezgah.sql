CREATE TABLE [GUSTO00003].[KY_Tezgah] (
  [KY_Tezgah_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Tezgah_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00003].[KY_Tezgah] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO