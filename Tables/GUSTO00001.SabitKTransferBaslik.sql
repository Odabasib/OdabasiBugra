CREATE TABLE [GUSTO00001].[SabitKTransferBaslik] (
...
CREATE INDEX [HareketTuruSeriNoKey]
  ON [GUSTO00001].[SabitKTransferBaslik] ([nHareketTuru], [sSeri], [lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[SabitKTransferBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKaynakBelge]
  ON [GUSTO00001].[SabitKTransferBaslik] ([pKaynakBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO