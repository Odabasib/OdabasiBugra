CREATE TABLE [GUSTO00003].[IzlemeKodu] (
...
CREATE INDEX [AdKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [KodKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SadeceKodKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDurumuKodKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [cStoktaVarMi], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKey]
  ON [GUSTO00003].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO