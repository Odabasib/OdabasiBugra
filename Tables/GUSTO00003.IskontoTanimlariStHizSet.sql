CREATE TABLE [GUSTO00003].[IskontoTanimlariStHizSet] (
...
CREATE UNIQUE INDEX [IskontoTanimiStok]
  ON [GUSTO00003].[IskontoTanimlariStHizSet] ([pIskontoTanimi], [cStokHizmetSet], [pStokHizmetSetKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIskontoTanimi]
  ON [GUSTO00003].[IskontoTanimlariStHizSet] ([pIskontoTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO