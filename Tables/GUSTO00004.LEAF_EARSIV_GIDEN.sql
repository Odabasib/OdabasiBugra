CREATE TABLE [GUSTO00004].[LEAF_EARSIV_GIDEN] (
...
CREATE INDEX [IND_LEAFGIDEN]
  ON [GUSTO00004].[LEAF_EARSIV_GIDEN] ([PFATURA], [PCARIID], [NDURUMU])
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEAFGIDENETTN]
  ON [GUSTO00004].[LEAF_EARSIV_GIDEN] ([ETTN])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [IND_LEAFGIDENNO]
  ON [GUSTO00004].[LEAF_EARSIV_GIDEN] ([EFATURANO])
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEAFGIDENZARF]
  ON [GUSTO00004].[LEAF_EARSIV_GIDEN] ([PZARFID])
  ON [PRIMARY]
GO