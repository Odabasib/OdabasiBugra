CREATE TABLE [GUSTO00003].[UrunMaliyeti] (
...
CREATE INDEX [pKodTanimi]
  ON [GUSTO00003].[UrunMaliyeti] ([pKodTanimi], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMalzemeKodu]
  ON [GUSTO00003].[UrunMaliyeti] ([pMalzemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunKodu]
  ON [GUSTO00003].[UrunMaliyeti] ([pUrunKodu], [cStokHizmet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[UrunMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO