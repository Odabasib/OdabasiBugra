CREATE TABLE [GUSTO00001].[VerTemMekOdemeler] (
...
CREATE INDEX [dtOdemeGunu]
  ON [GUSTO00001].[VerTemMekOdemeler] ([dtOdemeGunu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekHarTarihKey]
  ON [GUSTO00001].[VerTemMekOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MektupOdemeKey]
  ON [GUSTO00001].[VerTemMekOdemeler] ([pMektup])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO