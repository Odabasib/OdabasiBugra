CREATE TABLE [GUSTO00005].[PersonelKidemIhbar] (
...
CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00005].[PersonelKidemIhbar] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00005].[PersonelKidemIhbar] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00005].[PersonelKidemIhbar] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO