CREATE TABLE [GUSTO00003].[CSBordrosu] (
...
CREATE INDEX [KarsiHesapTarihKey]
  ON [GUSTO00003].[CSBordrosu] ([pKarsiKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarihKey]
  ON [GUSTO00003].[CSBordrosu] ([pSCKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihSeriKey]
  ON [GUSTO00003].[CSBordrosu] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurSeriKey]
  ON [GUSTO00003].[CSBordrosu] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO