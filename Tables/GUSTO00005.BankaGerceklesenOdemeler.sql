CREATE TABLE [GUSTO00005].[BankaGerceklesenOdemeler] (
...
CREATE INDEX [pBankaHareket]
  ON [GUSTO00005].[BankaGerceklesenOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBankaOdeme]
  ON [GUSTO00005].[BankaGerceklesenOdemeler] ([pBankaOdeme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO