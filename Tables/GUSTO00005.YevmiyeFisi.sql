CREATE TABLE [GUSTO00005].[YevmiyeFisi] (
...
CREATE INDEX [Donem]
  ON [GUSTO00005].[YevmiyeFisi] ([pDonem])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FisNo]
  ON [GUSTO00005].[YevmiyeFisi] ([lFisNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[YevmiyeFisi] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YevmiyeNo]
  ON [GUSTO00005].[YevmiyeFisi] ([lYevmiyeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO