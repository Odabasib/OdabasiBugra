CREATE TABLE [GUSTO00003].[Rezervasyon] (
...
CREATE INDEX [CariKey]
  ON [GUSTO00003].[Rezervasyon] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KoyulanRzvKey]
  ON [GUSTO00003].[Rezervasyon] ([pRzvKoyulanBelge], [sRzvKoyulanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KullaniciKey]
  ON [GUSTO00003].[Rezervasyon] ([pOlusturanKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguRzv]
  ON [GUSTO00003].[Rezervasyon] ([pBagliOlduguRzv])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokHareket]
  ON [GUSTO00003].[Rezervasyon] ([pStokHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [RezYapanTumKey]
  ON [GUSTO00003].[Rezervasyon] ([pRzvYapanBelge], [sRzvYapanTur], [pRzvKoyulanBelge], [sRzvKoyulanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [RzvYapanTurKey]
  ON [GUSTO00003].[Rezervasyon] ([sRzvYapanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00003].[Rezervasyon] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKey]
  ON [GUSTO00003].[Rezervasyon] ([pStok], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00003].[Rezervasyon] ([dtRezervasyonTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO