CREATE TABLE [GUSTO00005].[IsEmriFasonHareketler] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00005].[IsEmriFasonHareketler] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[IsEmriFasonHareketler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO