CREATE TABLE [GUSTO00003].[IsEmriPersonelDuruslari] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriPersonelDuruslari] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[IsEmriPersonelDuruslari] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO