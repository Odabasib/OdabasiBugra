CREATE TABLE [GUSTO00001].[IsBasvurulari] (
...
CREATE INDEX [AdSoyadDogumTarihiKey]
  ON [GUSTO00001].[IsBasvurulari] ([sAdi], [sSoyadi], [dtDogumTarihi], [sAnneKizlikSoyadi], [sSeri], [nNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [DegerlendirmeGorevTanimi]
  ON [GUSTO00001].[IsBasvurulari] ([pDegerlendirme], [pGorevTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO