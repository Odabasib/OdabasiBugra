CREATE TABLE [GUSTO00001].[TezgahDirekGiderleri] (
...
CREATE INDEX [pDirekHesapKodu]
  ON [GUSTO00001].[TezgahDirekGiderleri] ([pDirekHesapKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOperasyon]
  ON [GUSTO00001].[TezgahDirekGiderleri] ([pOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TezgahTezgahSinifi]
  ON [GUSTO00001].[TezgahDirekGiderleri] ([pTezgahTezgahSinifiKodu], [pSabitKymKodu], [cTezgahTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO