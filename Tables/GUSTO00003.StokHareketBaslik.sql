CREATE TABLE [GUSTO00003].[StokHareketBaslik] (
...
CREATE INDEX [CariKodu]
  ON [GUSTO00003].[StokHareketBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [EIrsaliyeCariTur]
  ON [GUSTO00003].[StokHareketBaslik] ([nEIrsaliyeDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Fatura]
  ON [GUSTO00003].[StokHareketBaslik] ([pFatura])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemID]
  ON [GUSTO00003].[StokHareketBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00003].[StokHareketBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[StokHareketBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO