CREATE TABLE [GUSTO00001].[PerformansDegerlendirme] (
...
CREATE UNIQUE INDEX [PerformansTanimDonemPers]
  ON [GUSTO00001].[PerformansDegerlendirme] ([cDegerlendirmeTuru], [pPerformansTanimi], [pDegerlentirmeTuru], [pDegerlendirmeDonemi], [pPersonel], [pOrganizasyon], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO