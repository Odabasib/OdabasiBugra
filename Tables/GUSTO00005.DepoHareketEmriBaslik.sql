CREATE TABLE [GUSTO00005].[DepoHareketEmriBaslik] (
...
CREATE INDEX [Depo]
  ON [GUSTO00005].[DepoHareketEmriBaslik] ([pDepoCikis], [pDepoGiris])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00005].[DepoHareketEmriBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[DepoHareketEmriBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO