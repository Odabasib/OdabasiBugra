CREATE TABLE [GUSTO00003].[StandartMaliyetSatir] (
...
CREATE INDEX [pHesap]
  ON [GUSTO00003].[StandartMaliyetSatir] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunSatiri]
  ON [GUSTO00003].[StandartMaliyetSatir] ([pUrunSatiri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00003].[StandartMaliyetSatir] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO