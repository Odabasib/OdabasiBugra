CREATE TABLE [GUSTO00001].[YazarKasaKodu] (
...
CREATE INDEX [nYazarKasaTur]
  ON [GUSTO00001].[YazarKasaKodu] ([nYazarKasaTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[YazarKasaKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00001].[YazarKasaKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyYazarKasa]
  ON [GUSTO00001].[YazarKasaKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyYazarKasa]
  ON [GUSTO00001].[YazarKasaKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO