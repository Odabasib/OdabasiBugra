CREATE TABLE [GUSTO00005].[SabitKHareket] (
...
CREATE INDEX [IslemYilDonem]
  ON [GUSTO00005].[SabitKHareket] ([nHareketYili], [nIslemDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00005].[SabitKHareket] ([pIslemId], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SabitKHareketIzlemeYilTip]
  ON [GUSTO00005].[SabitKHareket] ([pSKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO