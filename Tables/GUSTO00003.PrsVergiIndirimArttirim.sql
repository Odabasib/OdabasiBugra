CREATE TABLE [GUSTO00003].[PrsVergiIndirimArttirim] (
...
CREATE INDEX [PersonelYilAyVerIndArtKey]
  ON [GUSTO00003].[PrsVergiIndirimArttirim] ([pPersonel], [pIsyeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VerIndArtYilAyKey]
  ON [GUSTO00003].[PrsVergiIndirimArttirim] ([pVergiArttirimIndirim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO