CREATE TABLE [GUSTO00003].[Organizasyon] (
...
CREATE INDEX [ORG_UstAdKey]
  ON [GUSTO00003].[Organizasyon] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ORG_UstKodKey]
  ON [GUSTO00003].[Organizasyon] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGiderYeri]
  ON [GUSTO00003].[Organizasyon] ([pGiderYeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00003].[Organizasyon] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00003].[Organizasyon] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO