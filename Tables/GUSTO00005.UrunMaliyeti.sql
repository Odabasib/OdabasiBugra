CREATE TABLE [GUSTO00005].[UrunMaliyeti] (
...
CREATE INDEX [pKodTanimi]
  ON [GUSTO00005].[UrunMaliyeti] ([pKodTanimi], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMalzemeKodu]
  ON [GUSTO00005].[UrunMaliyeti] ([pMalzemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunKodu]
  ON [GUSTO00005].[UrunMaliyeti] ([pUrunKodu], [cStokHizmet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[UrunMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO