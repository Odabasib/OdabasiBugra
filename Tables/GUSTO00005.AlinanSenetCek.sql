CREATE TABLE [GUSTO00005].[AlinanSenetCek] (
...
CREATE INDEX [BorcluVadeKey]
  ON [GUSTO00005].[AlinanSenetCek] ([pBorcluKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtAlinisTarihi]
  ON [GUSTO00005].[AlinanSenetCek] ([dtAlinisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVadeTarihi]
  ON [GUSTO00005].[AlinanSenetCek] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVadeKey]
  ON [GUSTO00005].[AlinanSenetCek] ([pSonKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO