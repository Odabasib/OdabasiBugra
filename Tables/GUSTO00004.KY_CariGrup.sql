CREATE TABLE [GUSTO00004].[KY_CariGrup] (
  [KY_CariGrup_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_CariGrup_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_CariGrup] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO