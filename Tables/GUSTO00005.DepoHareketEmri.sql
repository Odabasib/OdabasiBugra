CREATE TABLE [GUSTO00005].[DepoHareketEmri] (
...
CREATE INDEX [Baslik]
  ON [GUSTO00005].[DepoHareketEmri] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Depo]
  ON [GUSTO00005].[DepoHareketEmri] ([pDepo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00005].[DepoHareketEmri] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Sira]
  ON [GUSTO00005].[DepoHareketEmri] ([nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Stok]
  ON [GUSTO00005].[DepoHareketEmri] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[DepoHareketEmri] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO