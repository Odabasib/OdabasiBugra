CREATE TABLE [GUSTO00004].[Rezervasyon] (
...
CREATE INDEX [CariKey]
  ON [GUSTO00004].[Rezervasyon] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KoyulanRzvKey]
  ON [GUSTO00004].[Rezervasyon] ([pRzvKoyulanBelge], [sRzvKoyulanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KullaniciKey]
  ON [GUSTO00004].[Rezervasyon] ([pOlusturanKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguRzv]
  ON [GUSTO00004].[Rezervasyon] ([pBagliOlduguRzv])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokHareket]
  ON [GUSTO00004].[Rezervasyon] ([pStokHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [RezYapanTumKey]
  ON [GUSTO00004].[Rezervasyon] ([pRzvYapanBelge], [sRzvYapanTur], [pRzvKoyulanBelge], [sRzvKoyulanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [RzvYapanTurKey]
  ON [GUSTO00004].[Rezervasyon] ([sRzvYapanTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00004].[Rezervasyon] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKey]
  ON [GUSTO00004].[Rezervasyon] ([pStok], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00004].[Rezervasyon] ([dtRezervasyonTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO