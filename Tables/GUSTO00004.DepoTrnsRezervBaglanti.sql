CREATE TABLE [GUSTO00004].[DepoTrnsRezervBaglanti] (
...
CREATE INDEX [CikisRezervasyonKey]
  ON [GUSTO00004].[DepoTrnsRezervBaglanti] ([pDepoTransfer], [pCikisRezervasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GirisRezervasyonKey]
  ON [GUSTO00004].[DepoTrnsRezervBaglanti] ([pDepoTransfer], [pGirisRezervasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO