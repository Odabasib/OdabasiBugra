CREATE TABLE [GUSTO00005].[MaliTabloKodTanimiXML] (
  [MaliTabloKodTanimiXML_rowid] [int] IDENTITY,
  [MaliTabloKodTanimiRowid] [varchar](30) NULL DEFAULT (''),
  [nMaxSeviye] [varchar](30) NULL DEFAULT (''),
  [nSerbest] [varchar](30) NULL DEFAULT (''),
  ...
  PRIMARY KEY CLUSTERED ([MaliTabloKodTanimiXML_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO