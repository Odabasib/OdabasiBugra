CREATE TABLE [GUSTO00001].[MaliTabloKodu] (
...
CREATE INDEX [MTAdKey]
  ON [GUSTO00001].[MaliTabloKodu] ([pMaliTabloAd], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MTKodKey]
  ON [GUSTO00001].[MaliTabloKodu] ([pMaliTabloAd], [sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MTUstKodAdKey]
  ON [GUSTO00001].[MaliTabloKodu] ([pMaliTabloAd], [pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MTUstKodKodKey]
  ON [GUSTO00001].[MaliTabloKodu] ([pMaliTabloAd], [pUstKod], [sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO