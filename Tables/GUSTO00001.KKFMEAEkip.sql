CREATE TABLE [GUSTO00001].[KKFMEAEkip] (
...
CREATE INDEX [pBolum]
  ON [GUSTO00001].[KKFMEAEkip] ([pBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGorev]
  ON [GUSTO00001].[KKFMEAEkip] ([pGorev])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKKFMEABaslik]
  ON [GUSTO00001].[KKFMEAEkip] ([pKKFMEABaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00001].[KKFMEAEkip] ([pPersonelKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO