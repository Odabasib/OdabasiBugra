CREATE TABLE [GUSTO00001].[Organizasyon] (
...
CREATE INDEX [ORG_UstAdKey]
  ON [GUSTO00001].[Organizasyon] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ORG_UstKodKey]
  ON [GUSTO00001].[Organizasyon] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGiderYeri]
  ON [GUSTO00001].[Organizasyon] ([pGiderYeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[Organizasyon] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00001].[Organizasyon] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO