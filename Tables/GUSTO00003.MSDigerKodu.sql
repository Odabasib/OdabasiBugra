CREATE TABLE [GUSTO00003].[MSDigerKodu] (
...
CREATE INDEX [MSDUstKodAdKey]
  ON [GUSTO00003].[MSDigerKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSDUstKodKodKey]
  ON [GUSTO00003].[MSDigerKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00003].[MSDigerKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00003].[MSDigerKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO