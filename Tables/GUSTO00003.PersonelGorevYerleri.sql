CREATE TABLE [GUSTO00003].[PersonelGorevYerleri] (
...
CREATE INDEX [PGY_KadroAktifKey]
  ON [GUSTO00003].[PersonelGorevYerleri] ([pKadro], [dtGoreveBaslayis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PGY_PersAktifKey]
  ON [GUSTO00003].[PersonelGorevYerleri] ([pPersonel], [dtGoreveBaslayis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO