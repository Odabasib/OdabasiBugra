CREATE TABLE [GUSTO00005].[KontrolPlanKrkt] (
...
CREATE INDEX [cOrneklemeFrekansBirimi]
  ON [GUSTO00005].[KontrolPlanKrkt] ([cOrneklemeFrekansBirimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cOrneklemeFrekansTipi]
  ON [GUSTO00005].[KontrolPlanKrkt] ([cOrneklemeFrekansTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cToleransTipi]
  ON [GUSTO00005].[KontrolPlanKrkt] ([cToleransTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KontrolPlanKrk]
  ON [GUSTO00005].[KontrolPlanKrkt] ([pKontrolPlan], [pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKaliteKontrolYeri]
  ON [GUSTO00005].[KontrolPlanKrkt] ([pKaliteKontrolYeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00005].[KontrolPlanKrkt] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolPlan]
  ON [GUSTO00005].[KontrolPlanKrkt] ([pKontrolPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO