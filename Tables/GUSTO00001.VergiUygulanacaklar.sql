CREATE TABLE [GUSTO00001].[VergiUygulanacaklar] (
...
CREATE INDEX [Uygulama]
  ON [GUSTO00001].[VergiUygulanacaklar] ([pUygulanacakHesap], [cHesapTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vergi]
  ON [GUSTO00001].[VergiUygulanacaklar] ([pVergiTanimi], [cHesapTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO