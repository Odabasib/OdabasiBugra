CREATE TABLE [GUSTO00005].[MusteriSaticiDetayDevami] (
  [MusteriSaticiDetayDevami_rowid] [int] IDENTITY,
  ...
  [nRiskKriteri] [tinyint] NULL DEFAULT (0),
  ...
  [ldRiskOraniBakiye] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniKendiCek] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniCiroCek] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniKendiSenet] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniCiroSenet] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniSiparis] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniSevk] [decimal](22, 2) NULL DEFAULT (0),
  [ldRiskOraniIrsaliye] [decimal](22, 2) NULL DEFAULT (0),
  ...
  [sOutlookKlasorAdi] [varchar](250) NULL DEFAULT (''),
  [sOutlookEntryID] [varchar](150) NULL DEFAULT (''),
  [sOutlookKategori] [varchar](250) NULL DEFAULT (''),
  PRIMARY KEY CLUSTERED ([MusteriSaticiDetayDevami_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [pMusteriSaticiDetayi]
  ON [GUSTO00005].[MusteriSaticiDetayDevami] ([pMusteriSaticiDetayi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO