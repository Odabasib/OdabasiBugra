CREATE TABLE [GUSTO00003].[StokDetay] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[StokDetay] ([pStokKodu])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00003].[StokDetay] ([sBarkod1Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod2Birim]
  ON [GUSTO00003].[StokDetay] ([sBarkod2Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod3Birim]
  ON [GUSTO00003].[StokDetay] ([sBarkod3Birim])
  ON [PRIMARY]
GO