CREATE TABLE [GUSTO00005].[KKOlcumVeri] (
...
CREATE INDEX [OlcumVeriBaslikSiraNo]
  ON [GUSTO00005].[KKOlcumVeri] ([pKKOlcumVeriBaslik], [nSiraNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKKOlcumVeriBaslik]
  ON [GUSTO00005].[KKOlcumVeri] ([pKKOlcumVeriBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOlcenPersonel]
  ON [GUSTO00005].[KKOlcumVeri] ([pOlcenPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO