CREATE TABLE [GUSTO00005].[StdMaliyetBirimMaliyet] (
...
CREATE INDEX [pBaslik]
  ON [GUSTO00005].[StdMaliyetBirimMaliyet] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHesap]
  ON [GUSTO00005].[StdMaliyetBirimMaliyet] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00005].[StdMaliyetBirimMaliyet] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO