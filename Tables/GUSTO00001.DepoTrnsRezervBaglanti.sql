CREATE TABLE [GUSTO00001].[DepoTrnsRezervBaglanti] (
...
CREATE INDEX [CikisRezervasyonKey]
  ON [GUSTO00001].[DepoTrnsRezervBaglanti] ([pDepoTransfer], [pCikisRezervasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GirisRezervasyonKey]
  ON [GUSTO00001].[DepoTrnsRezervBaglanti] ([pDepoTransfer], [pGirisRezervasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO