CREATE TABLE [GUSTO00005].[KY_MaliTab] (
  [KY_MaliTab_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_MaliTab_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_MaliTab] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO