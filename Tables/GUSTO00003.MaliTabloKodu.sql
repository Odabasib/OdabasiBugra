CREATE TABLE [GUSTO00003].[MaliTabloKodu] (
...
CREATE INDEX [MTAdKey]
  ON [GUSTO00003].[MaliTabloKodu] ([pMaliTabloAd], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MTKodKey]
  ON [GUSTO00003].[MaliTabloKodu] ([pMaliTabloAd], [sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MTUstKodAdKey]
  ON [GUSTO00003].[MaliTabloKodu] ([pMaliTabloAd], [pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MTUstKodKodKey]
  ON [GUSTO00003].[MaliTabloKodu] ([pMaliTabloAd], [pUstKod], [sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO