CREATE TABLE [GUSTO00001].[Malzemeler] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00001].[Malzemeler] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciKodu]
  ON [GUSTO00001].[Malzemeler] ([pUrunAgaciKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciUrunler]
  ON [GUSTO00001].[Malzemeler] ([pUrunAgaciKodu], [pUrunler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO