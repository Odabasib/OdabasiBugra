CREATE TABLE [GUSTO00005].[AlinanCekHareket] (
...
CREATE UNIQUE INDEX [CekTarihKey]
  ON [GUSTO00005].[AlinanCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pCekBordrosu]
  ON [GUSTO00005].[AlinanCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00005].[AlinanCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO