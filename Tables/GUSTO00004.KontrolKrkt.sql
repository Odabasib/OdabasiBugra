CREATE TABLE [GUSTO00004].[KontrolKrkt] (
...
CREATE INDEX [cKontrolKrktTipi]
  ON [GUSTO00004].[KontrolKrkt] ([cKontrolKrktTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrktGrup]
  ON [GUSTO00004].[KontrolKrkt] ([pKontrolKrktGrup])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstKod]
  ON [GUSTO00004].[KontrolKrkt] ([pUstKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00004].[KontrolKrkt] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00004].[KontrolKrkt] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAd]
  ON [GUSTO00004].[KontrolKrkt] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKod]
  ON [GUSTO00004].[KontrolKrkt] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO