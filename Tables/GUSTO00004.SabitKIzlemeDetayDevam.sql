CREATE TABLE [GUSTO00004].[SabitKIzlemeDetayDevam] (
  [SabitKIzlemeDetayDevam_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([SabitKIzlemeDetayDevam_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO