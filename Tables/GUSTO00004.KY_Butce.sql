CREATE TABLE [GUSTO00004].[KY_Butce] (
  [KY_Butce_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Butce_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_Butce] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO