CREATE TABLE [GUSTO00001].[AcikHesapIslem] (
...
CREATE INDEX [Cari]
  ON [GUSTO00001].[AcikHesapIslem] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemTarih]
  ON [GUSTO00001].[AcikHesapIslem] ([dtIslemTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OlusturanHar]
  ON [GUSTO00001].[AcikHesapIslem] ([pOlusturanHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarih]
  ON [GUSTO00001].[AcikHesapIslem] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO