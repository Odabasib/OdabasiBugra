CREATE TABLE [GUSTO00001].[StokHareketBaslik] (
...
CREATE INDEX [_dta_index_StokHareketBaslik_7_1460121634__K44_K4_5_17_18_19]
  ON [GUSTO00001].[StokHareketBaslik] ([SubeKodu], [dtTarih])
  INCLUDE ([nHareketTuru], [ldToplamTutar], [ldToplamKDV], [ldToplamEkVergi])
  ON [PRIMARY]
GO

CREATE INDEX [CariKodu]
  ON [GUSTO00001].[StokHareketBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [EIrsaliyeCariTur]
  ON [GUSTO00001].[StokHareketBaslik] ([nEIrsaliyeDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Fatura]
  ON [GUSTO00001].[StokHareketBaslik] ([pFatura])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemID]
  ON [GUSTO00001].[StokHareketBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00001].[StokHareketBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[StokHareketBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE STATISTICS [_dta_stat_1460121634_4_44]
  ON [GUSTO00001].[StokHareketBaslik] ([dtTarih], [SubeKodu])
GO