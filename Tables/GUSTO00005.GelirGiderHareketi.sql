CREATE TABLE [GUSTO00005].[GelirGiderHareketi] (
...
CREATE INDEX [HareketKey]
  ON [GUSTO00005].[GelirGiderHareketi] ([pHareketID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pButceKodu]
  ON [GUSTO00005].[GelirGiderHareketi] ([pButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00005].[GelirGiderHareketi] ([dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurTarihKey]
  ON [GUSTO00005].[GelirGiderHareketi] ([pGelirGiderTuruKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YerTarihKey]
  ON [GUSTO00005].[GelirGiderHareketi] ([pGelirGiderYeriKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO