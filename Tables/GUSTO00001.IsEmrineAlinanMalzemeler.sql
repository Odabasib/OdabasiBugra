CREATE TABLE [GUSTO00001].[IsEmrineAlinanMalzemeler] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00001].[IsEmrineAlinanMalzemeler] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00001].[IsEmrineAlinanMalzemeler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO