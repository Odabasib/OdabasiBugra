CREATE TABLE [GUSTO00004].[AlacakSenetHareket] (
...
CREATE UNIQUE INDEX [HareketSirasi]
  ON [GUSTO00004].[AlacakSenetHareket] ([pSenet], [nSiraNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[AlacakSenetHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSenetBordrosu]
  ON [GUSTO00004].[AlacakSenetHareket] ([pSenetBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO