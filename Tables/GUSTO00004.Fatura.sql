CREATE TABLE [GUSTO00004].[Fatura] (
...
CREATE INDEX [Cari]
  ON [GUSTO00004].[Fatura] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaNo]
  ON [GUSTO00004].[Fatura] ([lFaturaNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaTarih]
  ON [GUSTO00004].[Fatura] ([dtFaturaTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FCariTur]
  ON [GUSTO00004].[Fatura] ([nEFaturaDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemId]
  ON [GUSTO00004].[Fatura] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemIdMaliye]
  ON [GUSTO00004].[Fatura] ([pIslemIDMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarihi]
  ON [GUSTO00004].[Fatura] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO