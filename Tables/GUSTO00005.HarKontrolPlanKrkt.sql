CREATE TABLE [GUSTO00005].[HarKontrolPlanKrkt] (
...
CREATE INDEX [pHarKontrolPlan]
  ON [GUSTO00005].[HarKontrolPlanKrkt] ([pHarKontrolPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00005].[HarKontrolPlanKrkt] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolPlanKrkt]
  ON [GUSTO00005].[HarKontrolPlanKrkt] ([pKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO