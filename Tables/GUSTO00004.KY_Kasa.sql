CREATE TABLE [GUSTO00004].[KY_Kasa] (
  [KY_Kasa_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Kasa_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_Kasa] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO