CREATE TABLE [GUSTO00001].[GorevTanimlari] (
...
CREATE INDEX [pGiderTuru]
  ON [GUSTO00001].[GorevTanimlari] ([pGiderTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUnvanGrubu]
  ON [GUSTO00001].[GorevTanimlari] ([pUnvanGrubu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sGorevTanimAdi]
  ON [GUSTO00001].[GorevTanimlari] ([sGorevTanimAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sGorevTanimKodu]
  ON [GUSTO00001].[GorevTanimlari] ([sGorevTanimKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO