CREATE TABLE [GUSTO00005].[PersonelAvans] (
...
CREATE UNIQUE INDEX [PersonelYilAyKey]
  ON [GUSTO00005].[PersonelAvans] ([pPersonel], [nYil], [nAy], [pIkramiyeTanimi], [pIsyeri], [nAvansTuru], [pAvansTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00005].[PersonelAvans] ([nYil], [nAy], [pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO