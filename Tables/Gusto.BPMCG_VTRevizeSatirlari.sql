CREATE TABLE [Gusto].[BPMCG_VTRevizeSatirlari] (
  [ROWID] [int] IDENTITY,
...
ALTER TABLE [Gusto].[BPMCG_VTRevizeSatirlari]
  ADD CONSTRAINT [BPMCG_VTRevizeSatirlariONDELETE] FOREIGN KEY ([PPARENT]) REFERENCES [Gusto].[BPMFT_VTTEKLIFREVIZE] ([ROWID]) ON DELETE CASCADE
GO