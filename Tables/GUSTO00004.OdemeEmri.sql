CREATE TABLE [GUSTO00004].[OdemeEmri] (
...
CREATE INDEX [pIslemIDOdeme]
  ON [GUSTO00004].[OdemeEmri] ([pIslemIDOdeme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemIDVerilis]
  ON [GUSTO00004].[OdemeEmri] ([pIslemIDVerilis], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00004].[OdemeEmri] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VerilisTarKey]
  ON [GUSTO00004].[OdemeEmri] ([dtVerilisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO