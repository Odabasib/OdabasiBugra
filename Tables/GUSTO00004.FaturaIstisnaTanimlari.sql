CREATE TABLE [GUSTO00004].[FaturaIstisnaTanimlari] (
...
CREATE UNIQUE INDEX [AdTur]
  ON [GUSTO00004].[FaturaIstisnaTanimlari] ([sAd], [nIstisnaTuru], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [EvrenselKodTur]
  ON [GUSTO00004].[FaturaIstisnaTanimlari] ([sEvrenselKodu], [nIstisnaTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO