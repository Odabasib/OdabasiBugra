CREATE TABLE [GUSTO00004].[VerilenCekKart] (
...
CREATE INDEX [AlacakliSeriKey]
  ON [GUSTO00004].[VerilenCekKart] ([pAlacakliKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [BankaSeriKey]
  ON [GUSTO00004].[VerilenCekKart] ([pBanka])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaSeriKey]
  ON [GUSTO00004].[VerilenCekKart] ([pKasaKoduCikis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKarsiliksizIslemID]
  ON [GUSTO00004].[VerilenCekKart] ([pKarsiliksizIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSonDurumHrkID]
  ON [GUSTO00004].[VerilenCekKart] ([pSonDurumHrkID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTemCikIslemID]
  ON [GUSTO00004].[VerilenCekKart] ([pTemCikIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00004].[VerilenCekKart] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeKey]
  ON [GUSTO00004].[VerilenCekKart] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VerilisTarKey]
  ON [GUSTO00004].[VerilenCekKart] ([dtVerilisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO