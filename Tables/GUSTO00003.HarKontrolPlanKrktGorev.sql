CREATE TABLE [GUSTO00003].[HarKontrolPlanKrktGorev] (
...
CREATE INDEX [pGorevKodu]
  ON [GUSTO00003].[HarKontrolPlanKrktGorev] ([pGorevKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00003].[HarKontrolPlanKrktGorev] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO