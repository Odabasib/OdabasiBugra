CREATE TABLE [GUSTO00004].[VerTemMekOdemeler] (
...
CREATE INDEX [dtOdemeGunu]
  ON [GUSTO00004].[VerTemMekOdemeler] ([dtOdemeGunu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekHarTarihKey]
  ON [GUSTO00004].[VerTemMekOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MektupOdemeKey]
  ON [GUSTO00004].[VerTemMekOdemeler] ([pMektup])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO