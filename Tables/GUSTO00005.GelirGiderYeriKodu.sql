CREATE TABLE [GUSTO00005].[GelirGiderYeriKodu] (
...
CREATE INDEX [GGYGelirGiderKey]
  ON [GUSTO00005].[GelirGiderYeriKodu] ([cGelirGiderSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGYUstKodAdKey]
  ON [GUSTO00005].[GelirGiderYeriKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGYUstKodKey]
  ON [GUSTO00005].[GelirGiderYeriKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00005].[GelirGiderYeriKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00005].[GelirGiderYeriKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO