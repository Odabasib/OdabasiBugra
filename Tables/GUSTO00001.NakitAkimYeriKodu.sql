CREATE TABLE [GUSTO00001].[NakitAkimYeriKodu] (
...
CREATE INDEX [NAYGelirGiderKey]
  ON [GUSTO00001].[NakitAkimYeriKodu] ([cNakitAkimSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NAYUstKodAdKey]
  ON [GUSTO00001].[NakitAkimYeriKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NAYUstKodKey]
  ON [GUSTO00001].[NakitAkimYeriKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[NakitAkimYeriKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00001].[NakitAkimYeriKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO