CREATE TABLE [GUSTO00001].[Zimmet] (
...
CREATE INDEX [ZimmetIzKoduKey]
  ON [GUSTO00001].[Zimmet] ([pSabitKymIzKodu], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetPersonelKey]
  ON [GUSTO00001].[Zimmet] ([pPersonel], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetYerKey]
  ON [GUSTO00001].[Zimmet] ([pSabitKymYeri], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO