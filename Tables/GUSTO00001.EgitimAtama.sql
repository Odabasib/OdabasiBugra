CREATE TABLE [GUSTO00001].[EgitimAtama] (
...
CREATE INDEX [dtTarihpPlanpPersonel]
  ON [GUSTO00001].[EgitimAtama] ([dtTarih], [pPlan], [pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00001].[EgitimAtama] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPlan]
  ON [GUSTO00001].[EgitimAtama] ([pPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO