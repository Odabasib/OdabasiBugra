CREATE TABLE [GUSTO00004].[KY_MSDiger] (
  [KY_MSDiger_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_MSDiger_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_MSDiger] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO