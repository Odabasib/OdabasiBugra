CREATE TABLE [GUSTO00005].[HizmetDetayDevam] (
  [HizmetDetayDevam_rowid] [int] IDENTITY,
  ...
  [ldypTpTesviksizIhracatIadesi] [decimal](22, 2) NULL DEFAULT (0),
  ...
  PRIMARY KEY CLUSTERED ([HizmetDetayDevam_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO