CREATE TABLE [GUSTO00003].[GorevTanimlari] (
...
CREATE INDEX [pGiderTuru]
  ON [GUSTO00003].[GorevTanimlari] ([pGiderTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUnvanGrubu]
  ON [GUSTO00003].[GorevTanimlari] ([pUnvanGrubu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sGorevTanimAdi]
  ON [GUSTO00003].[GorevTanimlari] ([sGorevTanimAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sGorevTanimKodu]
  ON [GUSTO00003].[GorevTanimlari] ([sGorevTanimKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO