CREATE TABLE [GUSTO00001].[VerilenTeminatMektubu] (
...
CREATE INDEX [BankaNo]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([pBankaHesabi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariNo]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDVerilis]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([pIslemIDVerilis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([dtMektupTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00001].[VerilenTeminatMektubu] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO