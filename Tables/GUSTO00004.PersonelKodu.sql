CREATE TABLE [GUSTO00004].[PersonelKodu] (
...
CREATE INDEX [PK_sAdKey]
  ON [GUSTO00004].[PersonelKodu] ([sSoyad], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PK_UstKodAdKey]
  ON [GUSTO00004].[PersonelKodu] ([pUstKod], [sSoyad], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PK_UstKodKodKey]
  ON [GUSTO00004].[PersonelKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00004].[PersonelKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO