CREATE TABLE [GUSTO00004].[IsyeriSigortaBilgileri] (
...
CREATE INDEX [pIsyeri_AktifKey]
  ON [GUSTO00004].[IsyeriSigortaBilgileri] ([pIsyeri], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSigortaSirketi]
  ON [GUSTO00004].[IsyeriSigortaBilgileri] ([pSigortaSirketi], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO