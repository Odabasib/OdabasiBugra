CREATE TABLE [GUSTO00003].[AlinanSenetCek] (
...
CREATE INDEX [BorcluVadeKey]
  ON [GUSTO00003].[AlinanSenetCek] ([pBorcluKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtAlinisTarihi]
  ON [GUSTO00003].[AlinanSenetCek] ([dtAlinisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVadeTarihi]
  ON [GUSTO00003].[AlinanSenetCek] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVadeKey]
  ON [GUSTO00003].[AlinanSenetCek] ([pSonKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO