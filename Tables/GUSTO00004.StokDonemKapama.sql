CREATE TABLE [GUSTO00004].[StokDonemKapama] (
...
CREATE INDEX [StokDonem]
  ON [GUSTO00004].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDonemAy]
  ON [GUSTO00004].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi], [nAy])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO