CREATE TABLE [GUSTO00004].[KY_BordroTah] (
  [KY_BordroTah_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_BordroTah_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_BordroTah] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO