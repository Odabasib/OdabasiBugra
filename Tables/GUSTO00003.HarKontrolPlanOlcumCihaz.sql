CREATE TABLE [GUSTO00003].[HarKontrolPlanOlcumCihaz] (
...
CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00003].[HarKontrolPlanOlcumCihaz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahKodu]
  ON [GUSTO00003].[HarKontrolPlanOlcumCihaz] ([pTezgahKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahSinifi]
  ON [GUSTO00003].[HarKontrolPlanOlcumCihaz] ([pTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO