CREATE TABLE [GUSTO00005].[IsEmriBirlBaglantiTabl] (
...
CREATE INDEX [BirlesmisUyeIsemriKey]
  ON [GUSTO00005].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [BirlesmisUyeIsemriRzvYeriKey]
  ON [GUSTO00005].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri], [pRezervasyon], [pBirlesmisRzvYeriBelge], [pUyeRzvYeriBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBirlesmisIsEmri]
  ON [GUSTO00005].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUyeIsEmri]
  ON [GUSTO00005].[IsEmriBirlBaglantiTabl] ([pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO