CREATE TABLE [GUSTO00005].[DepoTrnsSetBaglanti] (
...
CREATE INDEX [DepoTrnsBaslikSetStokKey]
  ON [GUSTO00005].[DepoTrnsSetBaglanti] ([pDepoHareketBaslik], [bDepoTransferEmri], [pSetKodu], [pStokKodu], [pIzlemeKodu], [pDepoHareket], [pBagliOlduguSatir], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO