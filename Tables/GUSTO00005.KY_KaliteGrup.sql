CREATE TABLE [GUSTO00005].[KY_KaliteGrup] (
  [KY_KaliteGrup_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_KaliteGrup_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_KaliteGrup] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO