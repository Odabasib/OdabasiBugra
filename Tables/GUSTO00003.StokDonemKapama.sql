CREATE TABLE [GUSTO00003].[StokDonemKapama] (
...
CREATE INDEX [StokDonem]
  ON [GUSTO00003].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDonemAy]
  ON [GUSTO00003].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi], [nAy])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO