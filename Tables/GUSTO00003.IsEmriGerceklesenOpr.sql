CREATE TABLE [GUSTO00003].[IsEmriGerceklesenOpr] (
...
CREATE INDEX [dtIslemBitisTarihi]
  ON [GUSTO00003].[IsEmriGerceklesenOpr] ([dtIslemBitisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OperasyonSeri]
  ON [GUSTO00003].[IsEmriGerceklesenOpr] ([pIsEmriOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriGerceklesenOpr] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00003].[IsEmriGerceklesenOpr] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00003].[IsEmriGerceklesenOpr] ([nNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO