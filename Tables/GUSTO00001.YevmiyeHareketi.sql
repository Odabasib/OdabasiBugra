CREATE TABLE [GUSTO00001].[YevmiyeHareketi] (
...
CREATE INDEX [Donem]
  ON [GUSTO00001].[YevmiyeHareketi] ([pDonem])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Fis]
  ON [GUSTO00001].[YevmiyeHareketi] ([pYevmiyeFisi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FisNo]
  ON [GUSTO00001].[YevmiyeHareketi] ([lFisNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HesapDonemTar]
  ON [GUSTO00001].[YevmiyeHareketi] ([pHesapKodu], [pDonem], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HesapKodu]
  ON [GUSTO00001].[YevmiyeHareketi] ([pHesapKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemID]
  ON [GUSTO00001].[YevmiyeHareketi] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[YevmiyeHareketi] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UX_YEVHAR_YHT]
  ON [GUSTO00001].[YevmiyeHareketi] ([pDonem], [dtTarih])
  INCLUDE ([YevmiyeHareketi_rowid], [pYevmiyeFisi], [ldSira], [pHesapKodu], [bBorcMu], [ldTutar], [nEDefterHareketTuru], [dtEDefterBelgeTarihi], [sEDefterBelgeSeriNo], [sEDefterAciklama], [sEDefterOdemeSekli], [sEDefterHareketTurAciklama])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO