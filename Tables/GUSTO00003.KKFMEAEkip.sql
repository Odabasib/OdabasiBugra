CREATE TABLE [GUSTO00003].[KKFMEAEkip] (
...
CREATE INDEX [pBolum]
  ON [GUSTO00003].[KKFMEAEkip] ([pBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGorev]
  ON [GUSTO00003].[KKFMEAEkip] ([pGorev])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKKFMEABaslik]
  ON [GUSTO00003].[KKFMEAEkip] ([pKKFMEABaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00003].[KKFMEAEkip] ([pPersonelKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO