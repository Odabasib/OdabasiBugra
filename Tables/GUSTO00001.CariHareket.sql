CREATE TABLE [GUSTO00001].[CariHareket] (
...
CREATE INDEX [CH_SeriNoKey]
  ON [GUSTO00001].[CariHareket] ([nBelgeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pCariKodIDKey]
  ON [GUSTO00001].[CariHareket] ([pCariKodID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[CariHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKarsiHareketID]
  ON [GUSTO00001].[CariHareket] ([pKarsiHareketID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKarsiKodID]
  ON [GUSTO00001].[CariHareket] ([pKarsiKodID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00001].[CariHareket] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO