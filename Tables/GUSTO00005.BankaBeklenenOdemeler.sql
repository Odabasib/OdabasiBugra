CREATE TABLE [GUSTO00005].[BankaBeklenenOdemeler] (
...
CREATE INDEX [BankaTarihSira]
  ON [GUSTO00005].[BankaBeklenenOdemeler] ([pBankaHesabi], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekTarihBankaSira]
  ON [GUSTO00005].[BankaBeklenenOdemeler] ([pGerceklesenHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pRepoHareketi]
  ON [GUSTO00005].[BankaBeklenenOdemeler] ([pRepoHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO