CREATE TABLE [GUSTO00003].[YevmiyeFisi] (
...
CREATE INDEX [Donem]
  ON [GUSTO00003].[YevmiyeFisi] ([pDonem])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FisNo]
  ON [GUSTO00003].[YevmiyeFisi] ([lFisNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[YevmiyeFisi] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YevmiyeNo]
  ON [GUSTO00003].[YevmiyeFisi] ([lYevmiyeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO