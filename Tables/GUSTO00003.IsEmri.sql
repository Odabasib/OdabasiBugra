CREATE TABLE [GUSTO00003].[IsEmri] (
...
CREATE INDEX [nLevel]
  ON [GUSTO00003].[IsEmri] ([nLevel])
  ON [PRIMARY]
GO

CREATE INDEX [pMRPBaslik]
  ON [GUSTO00003].[IsEmri] ([pMRPBaslik])
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciKodu]
  ON [GUSTO00003].[IsEmri] ([pUrunAgaciKodu])
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00003].[IsEmri] ([nIsEmriNo])
  ON [PRIMARY]
GO

CREATE INDEX [TarihSeriKey]
  ON [GUSTO00003].[IsEmri] ([dtIsEmriTarihi])
  ON [PRIMARY]
GO