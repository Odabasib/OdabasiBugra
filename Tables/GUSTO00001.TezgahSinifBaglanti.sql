CREATE TABLE [GUSTO00001].[TezgahSinifBaglanti] (
...
CREATE INDEX [pTezgahKodu]
  ON [GUSTO00001].[TezgahSinifBaglanti] ([pTezgahKodu], [nOncelikKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahSinifiKodu]
  ON [GUSTO00001].[TezgahSinifBaglanti] ([pTezgahSinifiKodu], [nOncelikKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO