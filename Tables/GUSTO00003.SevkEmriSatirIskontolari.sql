CREATE TABLE [GUSTO00003].[SevkEmriSatirIskontolari] (
  [SevkEmriSatirIskontolari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([SevkEmriSatirIskontolari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [HareketSiraKey]
  ON [GUSTO00003].[SevkEmriSatirIskontolari] ([pSatir], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO