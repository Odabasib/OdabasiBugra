CREATE TABLE [GUSTO00003].[HarKontrolPlanOlcumSonuc] (
...
CREATE INDEX [cOlcumSonuc]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([cOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cOrneklemeNo]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([cOrneklemeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pVardiya]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([pVardiya])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00003].[HarKontrolPlanOlcumSonuc] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO