CREATE TABLE [GUSTO00001].[PersonelKidemIhbar] (
...
CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00001].[PersonelKidemIhbar] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00001].[PersonelKidemIhbar] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00001].[PersonelKidemIhbar] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO