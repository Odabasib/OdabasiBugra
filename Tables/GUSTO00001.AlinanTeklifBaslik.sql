CREATE TABLE [GUSTO00001].[AlinanTeklifBaslik] (
...
CREATE INDEX [CariOpsiyonTarKey]
  ON [GUSTO00001].[AlinanTeklifBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelOpsiyonTarKey]
  ON [GUSTO00001].[AlinanTeklifBaslik] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00001].[AlinanTeklifBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00001].[AlinanTeklifBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO