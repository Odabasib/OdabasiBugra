CREATE TABLE [GUSTO00003].[PersonelAnketSonuc] (
...
CREATE INDEX [BasvuruTarihKey]
  ON [GUSTO00003].[PersonelAnketSonuc] ([pBasvuru], [dtCevaplamaTarihi], [pAnket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pAnket]
  ON [GUSTO00003].[PersonelAnketSonuc] ([pAnket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelTarihKey]
  ON [GUSTO00003].[PersonelAnketSonuc] ([pHesapKodu], [dtCevaplamaTarihi], [pAnket], [cTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO