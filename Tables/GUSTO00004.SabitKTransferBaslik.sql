CREATE TABLE [GUSTO00004].[SabitKTransferBaslik] (
...
CREATE INDEX [HareketTuruSeriNoKey]
  ON [GUSTO00004].[SabitKTransferBaslik] ([nHareketTuru], [sSeri], [lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[SabitKTransferBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKaynakBelge]
  ON [GUSTO00004].[SabitKTransferBaslik] ([pKaynakBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO