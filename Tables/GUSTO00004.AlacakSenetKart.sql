CREATE TABLE [GUSTO00004].[AlacakSenetKart] (
...
CREATE INDEX [AlisTarKey]
  ON [GUSTO00004].[AlacakSenetKart] ([dtAlinisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [BorcluAlisTarKey]
  ON [GUSTO00004].[AlacakSenetKart] ([pBorcluKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaAlisTarKey]
  ON [GUSTO00004].[AlacakSenetKart] ([pSonKasa])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVadeKey]
  ON [GUSTO00004].[AlacakSenetKart] ([pSonKasa], [dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pProtestoIslemID]
  ON [GUSTO00004].[AlacakSenetKart] ([pProtestoIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSonDurumHrkID]
  ON [GUSTO00004].[AlacakSenetKart] ([pSonDurumHrkID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTemCikIslemID]
  ON [GUSTO00004].[AlacakSenetKart] ([pTemCikIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00004].[AlacakSenetKart] ([lSenetNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeKey]
  ON [GUSTO00004].[AlacakSenetKart] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO