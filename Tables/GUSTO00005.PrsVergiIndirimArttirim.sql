CREATE TABLE [GUSTO00005].[PrsVergiIndirimArttirim] (
...
CREATE INDEX [PersonelYilAyVerIndArtKey]
  ON [GUSTO00005].[PrsVergiIndirimArttirim] ([pPersonel], [pIsyeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VerIndArtYilAyKey]
  ON [GUSTO00005].[PrsVergiIndirimArttirim] ([pVergiArttirimIndirim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO