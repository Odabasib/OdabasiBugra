CREATE TABLE [GUSTO00003].[MGerceklesenOpr] (
...
CREATE INDEX [dtIslemBitisTarihi]
  ON [GUSTO00003].[MGerceklesenOpr] ([dtIslemBitisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [nLevel]
  ON [GUSTO00003].[MGerceklesenOpr] ([nLevel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00003].[MGerceklesenOpr] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00003].[MGerceklesenOpr] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO