CREATE TABLE [GUSTO00001].[PersonelAnketSonuc] (
...
CREATE INDEX [BasvuruTarihKey]
  ON [GUSTO00001].[PersonelAnketSonuc] ([pBasvuru], [dtCevaplamaTarihi], [pAnket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pAnket]
  ON [GUSTO00001].[PersonelAnketSonuc] ([pAnket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelTarihKey]
  ON [GUSTO00001].[PersonelAnketSonuc] ([pHesapKodu], [dtCevaplamaTarihi], [pAnket], [cTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO