CREATE TABLE [GUSTO00005].[VerilenTeklifSatir] (
...
CREATE INDEX [BagliSatir]
  ON [GUSTO00005].[VerilenTeklifSatir] ([pBagliOlduguSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Baslik]
  ON [GUSTO00005].[VerilenTeklifSatir] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariKodu]
  ON [GUSTO00005].[VerilenTeklifSatir] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FiyatLst]
  ON [GUSTO00005].[VerilenTeklifSatir] ([pFiyatListesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Opsiyon]
  ON [GUSTO00005].[VerilenTeklifSatir] ([dtOpsiyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00005].[VerilenTeklifSatir] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Stok]
  ON [GUSTO00005].[VerilenTeklifSatir] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[VerilenTeklifSatir] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO