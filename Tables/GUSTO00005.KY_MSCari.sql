CREATE TABLE [GUSTO00005].[KY_MSCari] (
  [KY_MSCari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_MSCari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_MSCari] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO