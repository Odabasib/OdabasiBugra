CREATE TABLE [GUSTO00004].[AlinanSenetCek] (
...
CREATE INDEX [BorcluVadeKey]
  ON [GUSTO00004].[AlinanSenetCek] ([pBorcluKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtAlinisTarihi]
  ON [GUSTO00004].[AlinanSenetCek] ([dtAlinisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVadeTarihi]
  ON [GUSTO00004].[AlinanSenetCek] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVadeKey]
  ON [GUSTO00004].[AlinanSenetCek] ([pSonKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO