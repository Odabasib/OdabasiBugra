CREATE TABLE [GUSTO00005].[KY_Organizasyon] (
  [KY_Organizasyon_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Organizasyon_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_Organizasyon] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO