CREATE TABLE [GUSTO00005].[PersonelIkramiye] (
...
CREATE INDEX [PersonelYilAyKey]
  ON [GUSTO00005].[PersonelIkramiye] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemId]
  ON [GUSTO00005].[PersonelIkramiye] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00005].[PersonelIkramiye] ([pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO