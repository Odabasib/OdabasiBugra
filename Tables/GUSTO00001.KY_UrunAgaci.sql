CREATE TABLE [GUSTO00001].[KY_UrunAgaci] (
  [KY_UrunAgaci_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_UrunAgaci_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00001].[KY_UrunAgaci] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO