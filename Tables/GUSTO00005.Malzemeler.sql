CREATE TABLE [GUSTO00005].[Malzemeler] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[Malzemeler] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciKodu]
  ON [GUSTO00005].[Malzemeler] ([pUrunAgaciKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciUrunler]
  ON [GUSTO00005].[Malzemeler] ([pUrunAgaciKodu], [pUrunler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO