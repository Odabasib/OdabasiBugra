CREATE TABLE [GUSTO00001].[MHarcananIscilik] (
...
CREATE INDEX [BitisTarihiKey]
  ON [GUSTO00001].[MHarcananIscilik] ([dtBitisTarihi], [tmBitisZamani])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00001].[MHarcananIscilik] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00001].[MHarcananIscilik] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO