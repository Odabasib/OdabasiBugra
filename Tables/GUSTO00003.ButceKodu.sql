CREATE TABLE [GUSTO00003].[ButceKodu] (
...
CREATE INDEX [sButceAdi]
  ON [GUSTO00003].[ButceKodu] ([sButceAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sButceKodu]
  ON [GUSTO00003].[ButceKodu] ([sButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKey]
  ON [GUSTO00003].[ButceKodu] ([pUstKod], [sButceAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKey]
  ON [GUSTO00003].[ButceKodu] ([pUstKod], [sButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO