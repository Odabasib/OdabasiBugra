CREATE TABLE [GUSTO00001].[IsBasvurusuNotlar] (
...
CREATE INDEX [OwnerIDTanimIDKey]
  ON [GUSTO00001].[IsBasvurusuNotlar] ([pOwnerID], [pTanimID], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelDegerlendimeKey]
  ON [GUSTO00001].[IsBasvurusuNotlar] ([pTanimID], [pDegerlendirme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO