CREATE TABLE [GUSTO00005].[IsEmriGercekOprMaliyeti] (
...
CREATE INDEX [dtTarih]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IsMerkeziTarihKey]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([pIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KodTanimiTarih]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([pKodTanimi], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([pIsemri], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UrunTarih]
  ON [GUSTO00005].[IsEmriGercekOprMaliyeti] ([pStokKodu], [dtTarih], [pKodTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO