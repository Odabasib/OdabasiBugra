CREATE TABLE [GUSTO00005].[MHarcananIscilik] (
...
CREATE INDEX [BitisTarihiKey]
  ON [GUSTO00005].[MHarcananIscilik] ([dtBitisTarihi], [tmBitisZamani])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00005].[MHarcananIscilik] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[MHarcananIscilik] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO