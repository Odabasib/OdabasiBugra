CREATE TABLE [GUSTO00005].[SabitKTransferSatir] (
...
CREATE INDEX [pSabitK_pSabitKIzlemeKey]
  ON [GUSTO00005].[SabitKTransferSatir] ([pSabitKKodu], [pSabitKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKIzlemeKoduKey]
  ON [GUSTO00005].[SabitKTransferSatir] ([pSabitKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKKoduKey]
  ON [GUSTO00005].[SabitKTransferSatir] ([pSabitKKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pZimmet]
  ON [GUSTO00005].[SabitKTransferSatir] ([pZimmet], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO