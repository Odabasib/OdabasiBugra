CREATE TABLE [GUSTO00001].[IsMerkeziDagitim] (
...
CREATE INDEX [pAlanIsMerkezi]
  ON [GUSTO00001].[IsMerkeziDagitim] ([pAlanIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VerenIsMerkeziYilAy]
  ON [GUSTO00001].[IsMerkeziDagitim] ([pVerenIsMerkezi], [nYil], [nAy], [pAlanIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO