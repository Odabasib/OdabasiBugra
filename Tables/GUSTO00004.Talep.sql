...
CREATE INDEX [pMRPBaslik]
  ON [GUSTO00004].[Talep] ([pMRPBaslik])
  ON [PRIMARY]
GO

CREATE INDEX [StokKey]
  ON [GUSTO00004].[Talep] ([pStok], [pIzlemeKodu])
  ON [PRIMARY]
GO

CREATE INDEX [TalepSeriNoKey]
  ON [GUSTO00004].[Talep] ([lNo])
  ON [PRIMARY]
GO

CREATE INDEX [TalepTarihKey]
  ON [GUSTO00004].[Talep] ([dtTarih])
  ON [PRIMARY]
GO

CREATE INDEX [TopluTalepSeriKey]
  ON [GUSTO00004].[Talep] ([pTopluTalep])
  ON [PRIMARY]
GO