CREATE TABLE [GUSTO00005].[GelirGiderTuruKodu] (
...
CREATE INDEX [GGTGelirGiderKey]
  ON [GUSTO00005].[GelirGiderTuruKodu] ([cGelirGiderSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodAdKey]
  ON [GUSTO00005].[GelirGiderTuruKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodKey]
  ON [GUSTO00005].[GelirGiderTuruKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00005].[GelirGiderTuruKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00005].[GelirGiderTuruKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO