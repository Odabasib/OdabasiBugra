CREATE TABLE [GUSTO00005].[YazarKasaKodu] (
...
CREATE INDEX [nYazarKasaTur]
  ON [GUSTO00005].[YazarKasaKodu] ([nYazarKasaTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00005].[YazarKasaKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00005].[YazarKasaKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyYazarKasa]
  ON [GUSTO00005].[YazarKasaKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyYazarKasa]
  ON [GUSTO00005].[YazarKasaKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO