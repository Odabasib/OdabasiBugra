CREATE TABLE [GUSTO00005].[AlinanTeminatMektubu] (
...
CREATE INDEX [CariNo]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pCari], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariTarih]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pCari], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariVade]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pCari], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaNo]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pSCKasasi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarih]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pSCKasasi], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVade]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pSCKasasi], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDAlis]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pIslemIDAlis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sMektupNo]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([sMektupNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00005].[AlinanTeminatMektubu] ([dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO