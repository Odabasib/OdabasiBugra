CREATE TABLE [GUSTO00003].[KKOlcumVeri] (
...
CREATE INDEX [OlcumVeriBaslikSiraNo]
  ON [GUSTO00003].[KKOlcumVeri] ([pKKOlcumVeriBaslik], [nSiraNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKKOlcumVeriBaslik]
  ON [GUSTO00003].[KKOlcumVeri] ([pKKOlcumVeriBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOlcenPersonel]
  ON [GUSTO00003].[KKOlcumVeri] ([pOlcenPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO