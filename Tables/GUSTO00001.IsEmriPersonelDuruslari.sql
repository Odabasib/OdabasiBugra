CREATE TABLE [GUSTO00001].[IsEmriPersonelDuruslari] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00001].[IsEmriPersonelDuruslari] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00001].[IsEmriPersonelDuruslari] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO