CREATE TABLE [GUSTO00001].[GelirGiderYeriKodu] (
...
CREATE INDEX [GGYGelirGiderKey]
  ON [GUSTO00001].[GelirGiderYeriKodu] ([cGelirGiderSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGYUstKodAdKey]
  ON [GUSTO00001].[GelirGiderYeriKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGYUstKodKey]
  ON [GUSTO00001].[GelirGiderYeriKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[GelirGiderYeriKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00001].[GelirGiderYeriKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO