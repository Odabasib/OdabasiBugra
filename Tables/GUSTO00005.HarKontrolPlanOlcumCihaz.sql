CREATE TABLE [GUSTO00005].[HarKontrolPlanOlcumCihaz] (
...
CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00005].[HarKontrolPlanOlcumCihaz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahKodu]
  ON [GUSTO00005].[HarKontrolPlanOlcumCihaz] ([pTezgahKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahSinifi]
  ON [GUSTO00005].[HarKontrolPlanOlcumCihaz] ([pTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO