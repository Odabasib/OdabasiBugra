CREATE TABLE [GUSTO00003].[OperasyonFormulEleman] (
...
CREATE UNIQUE INDEX [OperasyonElemanKey]
  ON [GUSTO00003].[OperasyonFormulEleman] ([pOperasyon], [cElemanTuru], [nElemanAddr], [nElemanNormalGeneric], [nElemanSira], [nSatirSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOperasyon]
  ON [GUSTO00003].[OperasyonFormulEleman] ([pOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO