CREATE TABLE [GUSTO00001].[StokEnflasyonFarki] (
...
CREATE INDEX [pIslemID]
  ON [GUSTO00001].[StokEnflasyonFarki] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [StokIzDepoMlytKodu]
  ON [GUSTO00001].[StokEnflasyonFarki] ([pDonem], [pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO