CREATE TABLE [GUSTO00003].[KY_StokGrup] (
  [KY_StokGrup_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_StokGrup_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00003].[KY_StokGrup] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO