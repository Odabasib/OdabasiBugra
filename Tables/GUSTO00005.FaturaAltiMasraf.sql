CREATE TABLE [GUSTO00005].[FaturaAltiMasraf] (
...
CREATE INDEX [FAMSiraKey]
  ON [GUSTO00005].[FaturaAltiMasraf] ([pFatura], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHizmetHareketi]
  ON [GUSTO00005].[FaturaAltiMasraf] ([pHizmetHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMasrafKodu]
  ON [GUSTO00005].[FaturaAltiMasraf] ([pMasrafKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO