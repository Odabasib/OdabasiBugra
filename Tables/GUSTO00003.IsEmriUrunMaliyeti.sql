CREATE TABLE [GUSTO00003].[IsEmriUrunMaliyeti] (
...
CREATE INDEX [dtTarih]
  ON [GUSTO00003].[IsEmriUrunMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriGercekMaliyet]
  ON [GUSTO00003].[IsEmriUrunMaliyeti] ([pIsEmriGercekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriUretilenUrun]
  ON [GUSTO00003].[IsEmriUrunMaliyeti] ([pIsEmriUretilenUrun])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsMerkezi]
  ON [GUSTO00003].[IsEmriUrunMaliyeti] ([pIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[IsEmriUrunMaliyeti] ([pStokKodu], [cStokHizmet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO