CREATE TABLE [GUSTO00005].[StandartMaliyetSatir] (
...
CREATE INDEX [pHesap]
  ON [GUSTO00005].[StandartMaliyetSatir] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunSatiri]
  ON [GUSTO00005].[StandartMaliyetSatir] ([pUrunSatiri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00005].[StandartMaliyetSatir] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO