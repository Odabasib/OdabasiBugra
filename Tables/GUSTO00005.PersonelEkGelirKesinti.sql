CREATE TABLE [GUSTO00005].[PersonelEkGelirKesinti] (
...
CREATE INDEX [EkGelirYilAyKey]
  ON [GUSTO00005].[PersonelEkGelirKesinti] ([pEkGelirKesinti], [pIkramiyeTanimi], [pIsyeri])
  ON [PRIMARY]
GO

CREATE INDEX [PersonelTipYilAyKey]
  ON [GUSTO00005].[PersonelEkGelirKesinti] ([pPersonel])
  ON [PRIMARY]
GO