CREATE TABLE [GUSTO00004].[IsEmriFasonHareketler] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00004].[IsEmriFasonHareketler] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[IsEmriFasonHareketler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO