CREATE TABLE [GUSTO00005].[GelirGiderTuruDetayi] (
  [GelirGiderTuruDetayi_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([GelirGiderTuruDetayi_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO