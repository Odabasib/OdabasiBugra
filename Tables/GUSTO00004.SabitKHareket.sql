CREATE TABLE [GUSTO00004].[SabitKHareket] (
...
CREATE INDEX [IslemYilDonem]
  ON [GUSTO00004].[SabitKHareket] ([nHareketYili], [nIslemDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00004].[SabitKHareket] ([pIslemId], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SabitKHareketIzlemeYilTip]
  ON [GUSTO00004].[SabitKHareket] ([pSKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO