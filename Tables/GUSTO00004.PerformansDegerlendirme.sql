CREATE TABLE [GUSTO00004].[PerformansDegerlendirme] (
...
CREATE UNIQUE INDEX [PerformansTanimDonemPers]
  ON [GUSTO00004].[PerformansDegerlendirme] ([cDegerlendirmeTuru], [pPerformansTanimi], [pDegerlentirmeTuru], [pDegerlendirmeDonemi], [pPersonel], [pOrganizasyon], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO