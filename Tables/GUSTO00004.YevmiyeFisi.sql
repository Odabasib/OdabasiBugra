CREATE TABLE [GUSTO00004].[YevmiyeFisi] (
...
CREATE INDEX [Donem]
  ON [GUSTO00004].[YevmiyeFisi] ([pDonem])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FisNo]
  ON [GUSTO00004].[YevmiyeFisi] ([lFisNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00004].[YevmiyeFisi] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YevmiyeNo]
  ON [GUSTO00004].[YevmiyeFisi] ([lYevmiyeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO