CREATE TABLE [GUSTO00003].[FasonHareket] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00003].[FasonHareket] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[FasonHareket] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[FasonHareket] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO