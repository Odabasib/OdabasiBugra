CREATE TABLE [GUSTO00003].[PersonelVergiIndArttirim] (
...
CREATE INDEX [PersonelVerInd_Aktifmi]
  ON [GUSTO00003].[PersonelVergiIndArttirim] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelVerInd_VerIndArt]
  ON [GUSTO00003].[PersonelVergiIndArttirim] ([pPersonel], [pVergiArttirimIndirim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO