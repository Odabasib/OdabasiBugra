CREATE TABLE [GUSTO00005].[VerilenCekHareket] (
...
CREATE INDEX [pCekBordrosu]
  ON [GUSTO00005].[VerilenCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00005].[VerilenCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VCHSiraKey]
  ON [GUSTO00005].[VerilenCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO