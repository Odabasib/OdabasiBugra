CREATE TABLE [GUSTO00003].[KY_Depo] (
  [KY_Depo_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Depo_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00003].[KY_Depo] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO