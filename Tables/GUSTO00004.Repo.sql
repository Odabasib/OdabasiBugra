...
CREATE INDEX [BankaTarihKey]
  ON [GUSTO00004].[Repo] ([pBanka], [dtRepoTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDCekme]
  ON [GUSTO00004].[Repo] ([pIslemIDCekme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemIDYatirma]
  ON [GUSTO00004].[Repo] ([pIslemIDYatirma], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00004].[Repo] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO