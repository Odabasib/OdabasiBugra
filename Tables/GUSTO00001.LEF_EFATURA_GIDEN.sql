CREATE TABLE [GUSTO00001].[LEF_EFATURA_GIDEN] (
...
CREATE INDEX [IND_LEFGIDEN]
  ON [GUSTO00001].[LEF_EFATURA_GIDEN] ([PFATURA], [PCARIID], [NDURUMU])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEFGIDENETTN]
  ON [GUSTO00001].[LEF_EFATURA_GIDEN] ([ETTN])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [IND_LEFGIDENNO]
  ON [GUSTO00001].[LEF_EFATURA_GIDEN] ([EFATURANO])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEFGIDENZARF]
  ON [GUSTO00001].[LEF_EFATURA_GIDEN] ([PZARFID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO