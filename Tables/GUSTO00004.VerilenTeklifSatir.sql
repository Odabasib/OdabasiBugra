CREATE TABLE [GUSTO00004].[VerilenTeklifSatir] (
  [VerilenTeklifSatir_rowid] [int] IDENTITY,
  ...
  [ldToplamAlinanSiparisMiktari1] [decimal](22, 6) NULL DEFAULT (0),
  [ldToplamAlinanSiparisMiktari2] [decimal](22, 6) NULL DEFAULT (0),
  [ldToplamAlinanSiparisMiktari3] [decimal](22, 6) NULL DEFAULT (0),
  ...
  PRIMARY KEY CLUSTERED ([VerilenTeklifSatir_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [BagliSatir]
  ON [GUSTO00004].[VerilenTeklifSatir] ([pBagliOlduguSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Baslik]
  ON [GUSTO00004].[VerilenTeklifSatir] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariKodu]
  ON [GUSTO00004].[VerilenTeklifSatir] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FiyatLst]
  ON [GUSTO00004].[VerilenTeklifSatir] ([pFiyatListesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Opsiyon]
  ON [GUSTO00004].[VerilenTeklifSatir] ([dtOpsiyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00004].[VerilenTeklifSatir] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Stok]
  ON [GUSTO00004].[VerilenTeklifSatir] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00004].[VerilenTeklifSatir] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO