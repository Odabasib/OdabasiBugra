CREATE TABLE [GUSTO00004].[IsBasvurusuNotlar] (
...
CREATE INDEX [OwnerIDTanimIDKey]
  ON [GUSTO00004].[IsBasvurusuNotlar] ([pOwnerID], [pTanimID], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelDegerlendimeKey]
  ON [GUSTO00004].[IsBasvurusuNotlar] ([pTanimID], [pDegerlendirme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO