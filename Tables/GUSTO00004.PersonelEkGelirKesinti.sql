CREATE TABLE [GUSTO00004].[PersonelEkGelirKesinti] (
...
CREATE INDEX [EkGelirYilAyKey]
  ON [GUSTO00004].[PersonelEkGelirKesinti] ([pEkGelirKesinti], [pIkramiyeTanimi], [pIsyeri])
  ON [PRIMARY]
GO

CREATE INDEX [PersonelTipYilAyKey]
  ON [GUSTO00004].[PersonelEkGelirKesinti] ([pPersonel])
  ON [PRIMARY]
GO