CREATE TABLE [GUSTO00003].[StokEnflasyonFarki] (
...
CREATE INDEX [pIslemID]
  ON [GUSTO00003].[StokEnflasyonFarki] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [StokIzDepoMlytKodu]
  ON [GUSTO00003].[StokEnflasyonFarki] ([pDonem], [pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO