CREATE TABLE [GUSTO00004].[SabitKTransferSatir] (
...
CREATE INDEX [pSabitK_pSabitKIzlemeKey]
  ON [GUSTO00004].[SabitKTransferSatir] ([pSabitKKodu], [pSabitKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKIzlemeKoduKey]
  ON [GUSTO00004].[SabitKTransferSatir] ([pSabitKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKKoduKey]
  ON [GUSTO00004].[SabitKTransferSatir] ([pSabitKKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pZimmet]
  ON [GUSTO00004].[SabitKTransferSatir] ([pZimmet], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO