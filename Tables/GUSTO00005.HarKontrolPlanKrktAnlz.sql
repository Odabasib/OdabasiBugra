CREATE TABLE [GUSTO00005].[HarKontrolPlanKrktAnlz] (
...
CREATE INDEX [cHataTipi]
  ON [GUSTO00005].[HarKontrolPlanKrktAnlz] ([cHataTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00005].[HarKontrolPlanKrktAnlz] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00005].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00005].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO