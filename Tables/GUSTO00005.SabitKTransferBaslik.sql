CREATE TABLE [GUSTO00005].[SabitKTransferBaslik] (
...
CREATE INDEX [HareketTuruSeriNoKey]
  ON [GUSTO00005].[SabitKTransferBaslik] ([nHareketTuru], [sSeri], [lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00005].[SabitKTransferBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKaynakBelge]
  ON [GUSTO00005].[SabitKTransferBaslik] ([pKaynakBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO