...
CREATE INDEX [BankaTarihKey]
  ON [GUSTO00003].[Repo] ([pBanka], [dtRepoTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDCekme]
  ON [GUSTO00003].[Repo] ([pIslemIDCekme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemIDYatirma]
  ON [GUSTO00003].[Repo] ([pIslemIDYatirma], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00003].[Repo] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO