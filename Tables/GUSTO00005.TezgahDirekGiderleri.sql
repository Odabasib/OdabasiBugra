CREATE TABLE [GUSTO00005].[TezgahDirekGiderleri] (
...
CREATE INDEX [pDirekHesapKodu]
  ON [GUSTO00005].[TezgahDirekGiderleri] ([pDirekHesapKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOperasyon]
  ON [GUSTO00005].[TezgahDirekGiderleri] ([pOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TezgahTezgahSinifi]
  ON [GUSTO00005].[TezgahDirekGiderleri] ([pTezgahTezgahSinifiKodu], [pSabitKymKodu], [cTezgahTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO