CREATE TABLE [GUSTO00004].[OperasyonFormulEleman] (
...
CREATE UNIQUE INDEX [OperasyonElemanKey]
  ON [GUSTO00004].[OperasyonFormulEleman] ([pOperasyon], [cElemanTuru], [nElemanAddr], [nElemanNormalGeneric], [nElemanSira], [nSatirSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOperasyon]
  ON [GUSTO00004].[OperasyonFormulEleman] ([pOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO