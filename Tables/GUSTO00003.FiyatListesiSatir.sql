CREATE TABLE [GUSTO00003].[FiyatListesiSatir] (
...
CREATE INDEX [FiyalListeStokKoduKey]
  ON [GUSTO00003].[FiyatListesiSatir] ([pFiyatListesiAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguSatir]
  ON [GUSTO00003].[FiyatListesiSatir] ([pBagliOlduguSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOdemeKosulu]
  ON [GUSTO00003].[FiyatListesiSatir] ([pOdemeKosulu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKoduKey]
  ON [GUSTO00003].[FiyatListesiSatir] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO