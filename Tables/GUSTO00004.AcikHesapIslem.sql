CREATE TABLE [GUSTO00004].[AcikHesapIslem] (
...
CREATE INDEX [Cari]
  ON [GUSTO00004].[AcikHesapIslem] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemTarih]
  ON [GUSTO00004].[AcikHesapIslem] ([dtIslemTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OlusturanHar]
  ON [GUSTO00004].[AcikHesapIslem] ([pOlusturanHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarih]
  ON [GUSTO00004].[AcikHesapIslem] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO