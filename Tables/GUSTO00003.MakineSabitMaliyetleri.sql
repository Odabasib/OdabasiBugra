CREATE TABLE [GUSTO00003].[MakineSabitMaliyetleri] (
...
CREATE INDEX [cTur]
  ON [GUSTO00003].[MakineSabitMaliyetleri] ([pKod], [pOperasyonMakina])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDirekGiderKodu]
  ON [GUSTO00003].[MakineSabitMaliyetleri] ([pDirekGiderKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO