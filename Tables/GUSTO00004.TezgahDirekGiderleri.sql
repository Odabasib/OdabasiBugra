CREATE TABLE [GUSTO00004].[TezgahDirekGiderleri] (
...
CREATE INDEX [pDirekHesapKodu]
  ON [GUSTO00004].[TezgahDirekGiderleri] ([pDirekHesapKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOperasyon]
  ON [GUSTO00004].[TezgahDirekGiderleri] ([pOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TezgahTezgahSinifi]
  ON [GUSTO00004].[TezgahDirekGiderleri] ([pTezgahTezgahSinifiKodu], [pSabitKymKodu], [cTezgahTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO