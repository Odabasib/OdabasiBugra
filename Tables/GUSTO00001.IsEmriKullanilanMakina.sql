CREATE TABLE [GUSTO00001].[IsEmriKullanilanMakina] (
...
CREATE INDEX [BitisTarihiKey]
  ON [GUSTO00001].[IsEmriKullanilanMakina] ([dtBitisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00001].[IsEmriKullanilanMakina] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00001].[IsEmriKullanilanMakina] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO