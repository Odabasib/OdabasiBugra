CREATE TABLE [GUSTO00001].[AlTekSatirIskontolari] (
  [AlTekSatirIskontolari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([AlTekSatirIskontolari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [HareketSiraKey]
  ON [GUSTO00001].[AlTekSatirIskontolari] ([pSatir], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO