CREATE TABLE [GUSTO00005].[CSBordrosu] (
...
CREATE INDEX [KarsiHesapTarihKey]
  ON [GUSTO00005].[CSBordrosu] ([pKarsiKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarihKey]
  ON [GUSTO00005].[CSBordrosu] ([pSCKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihSeriKey]
  ON [GUSTO00005].[CSBordrosu] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurSeriKey]
  ON [GUSTO00005].[CSBordrosu] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO