CREATE TABLE [GUSTO00003].[BankaGerceklesenOdemeler] (
...
CREATE INDEX [pBankaHareket]
  ON [GUSTO00003].[BankaGerceklesenOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBankaOdeme]
  ON [GUSTO00003].[BankaGerceklesenOdemeler] ([pBankaOdeme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO