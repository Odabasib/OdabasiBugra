CREATE TABLE [GUSTO00005].[KY_Stok] (
  [KY_Stok_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Stok_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_Stok] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO