CREATE TABLE [GUSTO00004].[MHarcananIscilik] (
...
CREATE INDEX [BitisTarihiKey]
  ON [GUSTO00004].[MHarcananIscilik] ([dtBitisTarihi], [tmBitisZamani])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[MHarcananIscilik] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[MHarcananIscilik] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO