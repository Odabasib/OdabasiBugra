CREATE TABLE [GUSTO00003].[IsEmriProsesIzleme] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriProsesIzleme] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[IsEmriProsesIzleme] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[IsEmriProsesIzleme] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO