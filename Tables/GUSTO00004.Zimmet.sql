CREATE TABLE [GUSTO00004].[Zimmet] (
...
CREATE INDEX [ZimmetIzKoduKey]
  ON [GUSTO00004].[Zimmet] ([pSabitKymIzKodu], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetPersonelKey]
  ON [GUSTO00004].[Zimmet] ([pPersonel], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetYerKey]
  ON [GUSTO00004].[Zimmet] ([pSabitKymYeri], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO