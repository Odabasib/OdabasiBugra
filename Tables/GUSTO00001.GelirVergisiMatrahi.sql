CREATE TABLE [GUSTO00001].[GelirVergisiMatrahi] (
...
CREATE INDEX [PersonelYilAyKey]
  ON [GUSTO00001].[GelirVergisiMatrahi] ([pPersonel], [nYil], [nAy], [pIkramiyeTanimi], [pIsyeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TipPersonelYilAyKey]
  ON [GUSTO00001].[GelirVergisiMatrahi] ([pPersonel], [nYil], [nAy], [pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO