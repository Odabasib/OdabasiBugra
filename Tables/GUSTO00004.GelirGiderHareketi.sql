CREATE TABLE [GUSTO00004].[GelirGiderHareketi] (
...
CREATE INDEX [HareketKey]
  ON [GUSTO00004].[GelirGiderHareketi] ([pHareketID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pButceKodu]
  ON [GUSTO00004].[GelirGiderHareketi] ([pButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00004].[GelirGiderHareketi] ([dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurTarihKey]
  ON [GUSTO00004].[GelirGiderHareketi] ([pGelirGiderTuruKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YerTarihKey]
  ON [GUSTO00004].[GelirGiderHareketi] ([pGelirGiderYeriKodu], [dtHareketTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO