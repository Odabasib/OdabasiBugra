CREATE TABLE [GUSTO00003].[IskontoTanimilariCari] (
...
CREATE INDEX [pIskontoTanimi]
  ON [GUSTO00003].[IskontoTanimilariCari] ([pIskontoTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIskontoTanimi_cTur_pCari]
  ON [GUSTO00003].[IskontoTanimilariCari] ([pIskontoTanimi], [cTur], [pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO