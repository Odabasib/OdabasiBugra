CREATE TABLE [GUSTO00003].[NakitAkimTuruKodu] (
...
CREATE INDEX [NATGelirGiderKey]
  ON [GUSTO00003].[NakitAkimTuruKodu] ([cNakitAkimSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NATUstKodAdKey]
  ON [GUSTO00003].[NakitAkimTuruKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NATUstKodKey]
  ON [GUSTO00003].[NakitAkimTuruKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00003].[NakitAkimTuruKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00003].[NakitAkimTuruKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO