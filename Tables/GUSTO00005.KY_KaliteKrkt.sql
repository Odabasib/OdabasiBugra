CREATE TABLE [GUSTO00005].[KY_KaliteKrkt] (
  [KY_KaliteKrkt_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_KaliteKrkt_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_KaliteKrkt] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO