CREATE TABLE [GUSTO00004].[StokEnflasyonFarki] (
...
CREATE INDEX [pIslemID]
  ON [GUSTO00004].[StokEnflasyonFarki] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [StokIzDepoMlytKodu]
  ON [GUSTO00004].[StokEnflasyonFarki] ([pDonem], [pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO