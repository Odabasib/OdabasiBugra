CREATE TABLE [GUSTO00005].[TalepIsEmriBaglanti] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00005].[TalepIsEmriBaglanti] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriMalzemeler]
  ON [GUSTO00005].[TalepIsEmriBaglanti] ([pIsEmriMalzemeler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTalep]
  ON [GUSTO00005].[TalepIsEmriBaglanti] ([pTalep])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO