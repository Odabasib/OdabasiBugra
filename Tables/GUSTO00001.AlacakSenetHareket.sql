CREATE TABLE [GUSTO00001].[AlacakSenetHareket] (
...
CREATE UNIQUE INDEX [HareketSirasi]
  ON [GUSTO00001].[AlacakSenetHareket] ([pSenet], [nSiraNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[AlacakSenetHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSenetBordrosu]
  ON [GUSTO00001].[AlacakSenetHareket] ([pSenetBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO