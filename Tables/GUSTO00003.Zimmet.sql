CREATE TABLE [GUSTO00003].[Zimmet] (
...
CREATE INDEX [ZimmetIzKoduKey]
  ON [GUSTO00003].[Zimmet] ([pSabitKymIzKodu], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetPersonelKey]
  ON [GUSTO00003].[Zimmet] ([pPersonel], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [ZimmetYerKey]
  ON [GUSTO00003].[Zimmet] ([pSabitKymYeri], [nAktif], [dtBaslangic])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO