CREATE TABLE [GUSTO00005].[AlinanTeklifSatir] (
...
CREATE INDEX [CariSeriNoKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariStokIzTarihBelgeKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OpsiyonTarKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([dtOpsiyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguSatir]
  ON [GUSTO00005].[AlinanTeklifSatir] ([pBagliOlduguSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VerTekStokKey]
  ON [GUSTO00005].[AlinanTeklifSatir] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO