CREATE TABLE [GUSTO00001].[UrunMaliyeti] (
...
CREATE INDEX [pKodTanimi]
  ON [GUSTO00001].[UrunMaliyeti] ([pKodTanimi], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMalzemeKodu]
  ON [GUSTO00001].[UrunMaliyeti] ([pMalzemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunKodu]
  ON [GUSTO00001].[UrunMaliyeti] ([pUrunKodu], [cStokHizmet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[UrunMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO