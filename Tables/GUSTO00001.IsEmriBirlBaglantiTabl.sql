CREATE TABLE [GUSTO00001].[IsEmriBirlBaglantiTabl] (
...
CREATE INDEX [BirlesmisUyeIsemriKey]
  ON [GUSTO00001].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [BirlesmisUyeIsemriRzvYeriKey]
  ON [GUSTO00001].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri], [pRezervasyon], [pBirlesmisRzvYeriBelge], [pUyeRzvYeriBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBirlesmisIsEmri]
  ON [GUSTO00001].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUyeIsEmri]
  ON [GUSTO00001].[IsEmriBirlBaglantiTabl] ([pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO