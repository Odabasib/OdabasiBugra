CREATE TABLE [GUSTO00004].[DigerHareket] (
...
CREATE INDEX [DH_TurSeriKey]
  ON [GUSTO00004].[DigerHareket] ([nHareketTuru], [nBelgeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDigerKodIDKey]
  ON [GUSTO00004].[DigerHareket] ([pDigerKodID], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[DigerHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKarsiHareketID]
  ON [GUSTO00004].[DigerHareket] ([pKarsiHareketID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKarsiKodID]
  ON [GUSTO00004].[DigerHareket] ([pKarsiKodID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO