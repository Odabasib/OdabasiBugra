CREATE TABLE [GUSTO00003].[MGercekOprMaliyeti] (
...
CREATE INDEX [dtTarih]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IsMerkeziTarihKey]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pIsMerkezi], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KodTanimiTarih]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pKodTanimi], [dtTarih], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGerceklesme]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pGerceklesme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pIsemri], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UrunTarih]
  ON [GUSTO00003].[MGercekOprMaliyeti] ([pStokKodu], [dtTarih], [pKodTanimi], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO