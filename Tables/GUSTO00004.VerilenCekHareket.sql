CREATE TABLE [GUSTO00004].[VerilenCekHareket] (
...
CREATE INDEX [pCekBordrosu]
  ON [GUSTO00004].[VerilenCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[VerilenCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VCHSiraKey]
  ON [GUSTO00004].[VerilenCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO