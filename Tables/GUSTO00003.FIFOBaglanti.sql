CREATE TABLE [GUSTO00003].[FIFOBaglanti] (
...
CREATE INDEX [pAlimHareketi]
  ON [GUSTO00003].[FIFOBaglanti] ([pAlimHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSatisHareketi]
  ON [GUSTO00003].[FIFOBaglanti] ([pSatisHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDepoCikisTarihKey]
  ON [GUSTO00003].[FIFOBaglanti] ([pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarihCikis], [nSiraCikis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDepoGirisTarihKey]
  ON [GUSTO00003].[FIFOBaglanti] ([pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarihGiris], [nSiraGiris])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO