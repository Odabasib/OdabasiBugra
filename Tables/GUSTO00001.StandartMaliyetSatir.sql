CREATE TABLE [GUSTO00001].[StandartMaliyetSatir] (
...
CREATE INDEX [pHesap]
  ON [GUSTO00001].[StandartMaliyetSatir] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunSatiri]
  ON [GUSTO00001].[StandartMaliyetSatir] ([pUrunSatiri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00001].[StandartMaliyetSatir] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO