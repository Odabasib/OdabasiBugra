CREATE TABLE [GUSTO00001].[StokDetay] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00001].[StokDetay] ([pStokKodu])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00001].[StokDetay] ([sBarkod1Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod2Birim]
  ON [GUSTO00001].[StokDetay] ([sBarkod2Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod3Birim]
  ON [GUSTO00001].[StokDetay] ([sBarkod3Birim])
  ON [PRIMARY]
GO