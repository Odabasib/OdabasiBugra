CREATE TABLE [GUSTO00004].[HarKontrolPlanOlcumCihaz] (
...
CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00004].[HarKontrolPlanOlcumCihaz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahKodu]
  ON [GUSTO00004].[HarKontrolPlanOlcumCihaz] ([pTezgahKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahSinifi]
  ON [GUSTO00004].[HarKontrolPlanOlcumCihaz] ([pTezgahSinifi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO