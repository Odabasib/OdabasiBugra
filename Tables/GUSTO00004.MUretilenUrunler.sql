CREATE TABLE [GUSTO00004].[MUretilenUrunler] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00004].[MUretilenUrunler] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[MUretilenUrunler] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIsEmriUretilenUrunler]
  ON [GUSTO00004].[MUretilenUrunler] ([pIsEmriUretilenUrunler], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pStokHareketSatir]
  ON [GUSTO00004].[MUretilenUrunler] ([pStokHareketSatir], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO