CREATE TABLE [GUSTO00001].[BorcSenediHareket] (
...
CREATE UNIQUE INDEX [HareketSirasi]
  ON [GUSTO00001].[BorcSenediHareket] ([pSenet], [nSiraNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HareketTipi]
  ON [GUSTO00001].[BorcSenediHareket] ([pSenet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[BorcSenediHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSenetBordrosu]
  ON [GUSTO00001].[BorcSenediHareket] ([pSenetBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO