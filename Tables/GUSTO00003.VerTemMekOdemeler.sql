CREATE TABLE [GUSTO00003].[VerTemMekOdemeler] (
...
CREATE INDEX [dtOdemeGunu]
  ON [GUSTO00003].[VerTemMekOdemeler] ([dtOdemeGunu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekHarTarihKey]
  ON [GUSTO00003].[VerTemMekOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MektupOdemeKey]
  ON [GUSTO00003].[VerTemMekOdemeler] ([pMektup])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO