CREATE TABLE [GUSTO00004].[GelirGiderTuruKodu] (
...
CREATE INDEX [GGTGelirGiderKey]
  ON [GUSTO00004].[GelirGiderTuruKodu] ([cGelirGiderSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodAdKey]
  ON [GUSTO00004].[GelirGiderTuruKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodKey]
  ON [GUSTO00004].[GelirGiderTuruKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00004].[GelirGiderTuruKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00004].[GelirGiderTuruKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO