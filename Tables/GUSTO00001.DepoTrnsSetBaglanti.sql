CREATE TABLE [GUSTO00001].[DepoTrnsSetBaglanti] (
...
CREATE INDEX [DepoTrnsBaslikSetStokKey]
  ON [GUSTO00001].[DepoTrnsSetBaglanti] ([pDepoHareketBaslik], [bDepoTransferEmri], [pSetKodu], [pStokKodu], [pIzlemeKodu], [pDepoHareket], [pBagliOlduguSatir], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO