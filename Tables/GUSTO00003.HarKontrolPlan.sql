CREATE TABLE [GUSTO00003].[HarKontrolPlan] (
...
CREATE INDEX [cKontrolAktiviteTipi]
  ON [GUSTO00003].[HarKontrolPlan] ([cKontrolAktiviteTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cKPlanGenelSonuc]
  ON [GUSTO00003].[HarKontrolPlan] ([cKPlanGenelSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00003].[HarKontrolPlan] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGirisDepoKodu]
  ON [GUSTO00003].[HarKontrolPlan] ([pGirisDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHedefDepoKodu]
  ON [GUSTO00003].[HarKontrolPlan] ([pHedefDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmri]
  ON [GUSTO00003].[HarKontrolPlan] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [psthrSatir]
  ON [GUSTO00003].[HarKontrolPlan] ([psthrSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00003].[HarKontrolPlan] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO