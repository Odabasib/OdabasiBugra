CREATE TABLE [GUSTO00003].[AlinanTeminatMektubu] (
...
CREATE INDEX [CariNo]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pCari], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariTarih]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pCari], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariVade]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pCari], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaNo]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pSCKasasi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarih]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pSCKasasi], [dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVade]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pSCKasasi], [dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDAlis]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pIslemIDAlis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sMektupNo]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([sMektupNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([dtMektupTarihi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00003].[AlinanTeminatMektubu] ([dtVadesi], [sMektupNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO