CREATE TABLE [GUSTO00005].[IzlemeKodu] (
...
CREATE INDEX [AdKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [KodKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SadeceKodKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDurumuKodKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [cStoktaVarMi], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKey]
  ON [GUSTO00005].[IzlemeKodu] ([cStokDemirbas], [pStokKodu], [pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO