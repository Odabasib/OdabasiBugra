CREATE TABLE [GUSTO00001].[LEI_EIRSALIYE_GIDEN] (
...
CREATE INDEX [IND_LEIGIDEN]
  ON [GUSTO00001].[LEI_EIRSALIYE_GIDEN] ([PIRSALIYE], [PCARIID], [NDURUMU])
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEIGIDENETTN]
  ON [GUSTO00001].[LEI_EIRSALIYE_GIDEN] ([ETTN])
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [IND_LEIGIDENNO]
  ON [GUSTO00001].[LEI_EIRSALIYE_GIDEN] ([EIRSALIYENO])
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEIGIDENZARF]
  ON [GUSTO00001].[LEI_EIRSALIYE_GIDEN] ([PZARFID])
  ON [PRIMARY]
GO