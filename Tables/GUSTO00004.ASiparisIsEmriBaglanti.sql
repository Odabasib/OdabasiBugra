CREATE TABLE [GUSTO00004].[ASiparisIsEmriBaglanti] (
...
CREATE INDEX [pBaglayanBelge]
  ON [GUSTO00004].[ASiparisIsEmriBaglanti] ([pBaglayanBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriUrunler]
  ON [GUSTO00004].[ASiparisIsEmriBaglanti] ([pIsEmriUrunler], [pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO