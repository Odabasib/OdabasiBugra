...
CREATE INDEX [BankaTarihKey]
  ON [GUSTO00001].[Repo] ([pBanka], [dtRepoTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDCekme]
  ON [GUSTO00001].[Repo] ([pIslemIDCekme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemIDYatirma]
  ON [GUSTO00001].[Repo] ([pIslemIDYatirma], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00001].[Repo] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO