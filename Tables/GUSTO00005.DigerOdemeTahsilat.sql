CREATE TABLE [GUSTO00005].[DigerOdemeTahsilat] (
...
CREATE INDEX [CariTurTarihKey]
  ON [GUSTO00005].[DigerOdemeTahsilat] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurSeriNoKey]
  ON [GUSTO00005].[DigerOdemeTahsilat] ([sKaynakTuru], [sSeri], [lNo], [pKaynakOdemePlani])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurTarihKey]
  ON [GUSTO00005].[DigerOdemeTahsilat] ([dtOdemeTarihi], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO