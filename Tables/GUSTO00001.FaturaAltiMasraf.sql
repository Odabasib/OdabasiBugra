CREATE TABLE [GUSTO00001].[FaturaAltiMasraf] (
...
CREATE INDEX [FAMSiraKey]
  ON [GUSTO00001].[FaturaAltiMasraf] ([pFatura], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHizmetHareketi]
  ON [GUSTO00001].[FaturaAltiMasraf] ([pHizmetHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pMasrafKodu]
  ON [GUSTO00001].[FaturaAltiMasraf] ([pMasrafKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO