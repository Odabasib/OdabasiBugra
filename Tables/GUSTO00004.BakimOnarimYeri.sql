CREATE TABLE [GUSTO00004].[BakimOnarimYeri] (
...
CREATE INDEX [BakimYeriTuruKodu]
  ON [GUSTO00004].[BakimOnarimYeri] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[BakimOnarimYeri] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[BakimOnarimYeri] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO