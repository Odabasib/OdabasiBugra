CREATE TABLE [GUSTO00004].[MakineSabitMaliyetleri] (
...
CREATE INDEX [cTur]
  ON [GUSTO00004].[MakineSabitMaliyetleri] ([pKod], [pOperasyonMakina])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDirekGiderKodu]
  ON [GUSTO00004].[MakineSabitMaliyetleri] ([pDirekGiderKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO