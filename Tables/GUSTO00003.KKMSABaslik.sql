CREATE TABLE [GUSTO00003].[KKMSABaslik] (
...
CREATE INDEX [lNo]
  ON [GUSTO00003].[KKMSABaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHazirlayan]
  ON [GUSTO00003].[KKMSABaslik] ([pHazirlayan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00003].[KKMSABaslik] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOlcumCihazi]
  ON [GUSTO00003].[KKMSABaslik] ([pOlcumCihazi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[KKMSABaslik] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00003].[KKMSABaslik] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO