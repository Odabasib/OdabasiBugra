CREATE TABLE [GUSTO00005].[ASiparisIsEmriBaglanti] (
...
CREATE INDEX [pBaglayanBelge]
  ON [GUSTO00005].[ASiparisIsEmriBaglanti] ([pBaglayanBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriUrunler]
  ON [GUSTO00005].[ASiparisIsEmriBaglanti] ([pIsEmriUrunler], [pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO