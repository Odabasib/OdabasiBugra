CREATE TABLE [GUSTO00003].[DepoHareketEmri] (
...
CREATE INDEX [Baslik]
  ON [GUSTO00003].[DepoHareketEmri] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Depo]
  ON [GUSTO00003].[DepoHareketEmri] ([pDepo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00003].[DepoHareketEmri] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Sira]
  ON [GUSTO00003].[DepoHareketEmri] ([nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Stok]
  ON [GUSTO00003].[DepoHareketEmri] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[DepoHareketEmri] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO