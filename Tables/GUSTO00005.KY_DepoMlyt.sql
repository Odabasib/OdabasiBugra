CREATE TABLE [GUSTO00005].[KY_DepoMlyt] (
  [KY_DepoMlyt_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_DepoMlyt_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_DepoMlyt] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO