CREATE TABLE [GUSTO00004].[IsEmriTezgahDuruslari] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00004].[IsEmriTezgahDuruslari] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[IsEmriTezgahDuruslari] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO