CREATE TABLE [GUSTO00004].[KY_IzleKodu] (
  [KY_IzleKodu_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_IzleKodu_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_IzleKodu] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO