CREATE TABLE [GUSTO00003].[IzlemeDetay] (
...
CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00003].[IzlemeDetay] ([sBarkod1Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod2Birim]
  ON [GUSTO00003].[IzlemeDetay] ([sBarkod2Birim])
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod3Birim]
  ON [GUSTO00003].[IzlemeDetay] ([sBarkod3Birim])
  ON [PRIMARY]
GO