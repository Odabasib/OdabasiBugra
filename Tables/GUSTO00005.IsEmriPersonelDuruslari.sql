CREATE TABLE [GUSTO00005].[IsEmriPersonelDuruslari] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00005].[IsEmriPersonelDuruslari] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[IsEmriPersonelDuruslari] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO