CREATE TABLE [GUSTO00004].[IsEmriGenelMasraf] (
...
CREATE INDEX [pHizmetHareketi]
  ON [GUSTO00004].[IsEmriGenelMasraf] ([pHizmetHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[IsEmriGenelMasraf] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[IsEmriGenelMasraf] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO