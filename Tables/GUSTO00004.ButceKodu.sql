CREATE TABLE [GUSTO00004].[ButceKodu] (
...
CREATE INDEX [sButceAdi]
  ON [GUSTO00004].[ButceKodu] ([sButceAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sButceKodu]
  ON [GUSTO00004].[ButceKodu] ([sButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKey]
  ON [GUSTO00004].[ButceKodu] ([pUstKod], [sButceAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKey]
  ON [GUSTO00004].[ButceKodu] ([pUstKod], [sButceKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO