CREATE TABLE [GUSTO00001].[VerilenSenetCek] (
...
CREATE INDEX [AlacakliVadeKey]
  ON [GUSTO00001].[VerilenSenetCek] ([pAlacakliKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVadeTarihi]
  ON [GUSTO00001].[VerilenSenetCek] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVerilisTarihi]
  ON [GUSTO00001].[VerilenSenetCek] ([dtVerilisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVerilisTarKey]
  ON [GUSTO00001].[VerilenSenetCek] ([pCikisKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO