CREATE TABLE [GUSTO00003].[IsEmriMalzemeler] (
...
CREATE INDEX [bYariMamul]
  ON [GUSTO00003].[IsEmriMalzemeler] ([bYariMamul])
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriMalzemeler] ([pIsemri], [pIsEmriUrunler])
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00003].[IsEmriMalzemeler] ([pStokKodu])
  ON [PRIMARY]
GO