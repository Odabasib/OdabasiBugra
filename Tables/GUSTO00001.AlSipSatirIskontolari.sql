CREATE TABLE [GUSTO00001].[AlSipSatirIskontolari] (
  [AlSipSatirIskontolari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([AlSipSatirIskontolari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [HareketSiraKey]
  ON [GUSTO00001].[AlSipSatirIskontolari] ([pSatir], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO