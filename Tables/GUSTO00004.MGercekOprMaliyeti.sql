CREATE TABLE [GUSTO00004].[MGercekOprMaliyeti] (
...
CREATE INDEX [dtTarih]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IsMerkeziTarihKey]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pIsMerkezi], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KodTanimiTarih]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pKodTanimi], [dtTarih], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGerceklesme]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pGerceklesme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pIsemri], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UrunTarih]
  ON [GUSTO00004].[MGercekOprMaliyeti] ([pStokKodu], [dtTarih], [pKodTanimi], [bEndirekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO