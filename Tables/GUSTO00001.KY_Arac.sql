CREATE TABLE [GUSTO00001].[KY_Arac] (
  [KY_Arac_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Arac_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00001].[KY_Arac] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO