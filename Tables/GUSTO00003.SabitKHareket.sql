CREATE TABLE [GUSTO00003].[SabitKHareket] (
...
CREATE INDEX [IslemYilDonem]
  ON [GUSTO00003].[SabitKHareket] ([nHareketYili], [nIslemDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00003].[SabitKHareket] ([pIslemId], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SabitKHareketIzlemeYilTip]
  ON [GUSTO00003].[SabitKHareket] ([pSKIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO