CREATE TABLE [GUSTO00004].[IsEmriMalzemeler] (
...
CREATE INDEX [bYariMamul]
  ON [GUSTO00004].[IsEmriMalzemeler] ([bYariMamul])
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[IsEmriMalzemeler] ([pIsemri], [pIsEmriUrunler])
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00004].[IsEmriMalzemeler] ([pStokKodu])
  ON [PRIMARY]
GO