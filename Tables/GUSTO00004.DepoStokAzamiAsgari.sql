CREATE TABLE [GUSTO00004].[DepoStokAzamiAsgari] (
...
CREATE INDEX [DepoStokAzamiAsgariBasBitTarKey]
  ON [GUSTO00004].[DepoStokAzamiAsgari] ([dtBasTar], [dtBitTar], [pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDepoKodu]
  ON [GUSTO00004].[DepoStokAzamiAsgari] ([pDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKoduKey]
  ON [GUSTO00004].[DepoStokAzamiAsgari] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO