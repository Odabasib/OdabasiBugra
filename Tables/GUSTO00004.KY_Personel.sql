CREATE TABLE [GUSTO00004].[KY_Personel] (
  [KY_Personel_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Personel_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_Personel] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO