CREATE TABLE [GUSTO00003].[StdMaliyetBirimMaliyet] (
...
CREATE INDEX [pBaslik]
  ON [GUSTO00003].[StdMaliyetBirimMaliyet] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHesap]
  ON [GUSTO00003].[StdMaliyetBirimMaliyet] ([pHesap])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstSatir]
  ON [GUSTO00003].[StdMaliyetBirimMaliyet] ([pUstSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO