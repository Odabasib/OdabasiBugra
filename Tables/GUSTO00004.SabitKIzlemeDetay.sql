CREATE TABLE [GUSTO00004].[SabitKIzlemeDetay] (
...
CREATE INDEX [pAlimHareketi]
  ON [GUSTO00004].[SabitKIzlemeDetay] ([pAlimHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKymTurleri]
  ON [GUSTO00004].[SabitKIzlemeDetay] ([pSabitKymTurleri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00004].[SabitKIzlemeDetay] ([sBarkod1Birim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO