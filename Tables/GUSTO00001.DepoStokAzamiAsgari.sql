CREATE TABLE [GUSTO00001].[DepoStokAzamiAsgari] (
...
CREATE INDEX [DepoStokAzamiAsgariBasBitTarKey]
  ON [GUSTO00001].[DepoStokAzamiAsgari] ([dtBasTar], [dtBitTar], [pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDepoKodu]
  ON [GUSTO00001].[DepoStokAzamiAsgari] ([pDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKoduKey]
  ON [GUSTO00001].[DepoStokAzamiAsgari] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO