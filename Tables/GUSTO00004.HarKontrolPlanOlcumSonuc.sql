CREATE TABLE [GUSTO00004].[HarKontrolPlanOlcumSonuc] (
...
CREATE INDEX [cOlcumSonuc]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([cOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cOrneklemeNo]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([cOrneklemeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pVardiya]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([pVardiya])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00004].[HarKontrolPlanOlcumSonuc] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO