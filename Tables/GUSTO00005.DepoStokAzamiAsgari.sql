CREATE TABLE [GUSTO00005].[DepoStokAzamiAsgari] (
...
CREATE INDEX [DepoStokAzamiAsgariBasBitTarKey]
  ON [GUSTO00005].[DepoStokAzamiAsgari] ([dtBasTar], [dtBitTar], [pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pDepoKodu]
  ON [GUSTO00005].[DepoStokAzamiAsgari] ([pDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKoduKey]
  ON [GUSTO00005].[DepoStokAzamiAsgari] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO