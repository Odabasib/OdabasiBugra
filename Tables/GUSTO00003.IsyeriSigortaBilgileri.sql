CREATE TABLE [GUSTO00003].[IsyeriSigortaBilgileri] (
...
CREATE INDEX [pIsyeri_AktifKey]
  ON [GUSTO00003].[IsyeriSigortaBilgileri] ([pIsyeri], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSigortaSirketi]
  ON [GUSTO00003].[IsyeriSigortaBilgileri] ([pSigortaSirketi], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO