CREATE TABLE [GUSTO00003].[AlacakSenetKart] (
...
CREATE INDEX [AlisTarKey]
  ON [GUSTO00003].[AlacakSenetKart] ([dtAlinisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [BorcluAlisTarKey]
  ON [GUSTO00003].[AlacakSenetKart] ([pBorcluKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaAlisTarKey]
  ON [GUSTO00003].[AlacakSenetKart] ([pSonKasa])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVadeKey]
  ON [GUSTO00003].[AlacakSenetKart] ([pSonKasa], [dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pProtestoIslemID]
  ON [GUSTO00003].[AlacakSenetKart] ([pProtestoIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSonDurumHrkID]
  ON [GUSTO00003].[AlacakSenetKart] ([pSonDurumHrkID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTemCikIslemID]
  ON [GUSTO00003].[AlacakSenetKart] ([pTemCikIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00003].[AlacakSenetKart] ([lSenetNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeKey]
  ON [GUSTO00003].[AlacakSenetKart] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO