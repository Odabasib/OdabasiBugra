CREATE TABLE [GUSTO00005].[FiyatListesiSatir] (
...
CREATE INDEX [FiyalListeStokKoduKey]
  ON [GUSTO00005].[FiyatListesiSatir] ([pFiyatListesiAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguSatir]
  ON [GUSTO00005].[FiyatListesiSatir] ([pBagliOlduguSatir])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pOdemeKosulu]
  ON [GUSTO00005].[FiyatListesiSatir] ([pOdemeKosulu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokKoduKey]
  ON [GUSTO00005].[FiyatListesiSatir] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO