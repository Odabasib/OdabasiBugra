CREATE TABLE [GUSTO00004].[TezgahSinifBaglanti] (
...
CREATE INDEX [pTezgahKodu]
  ON [GUSTO00004].[TezgahSinifBaglanti] ([pTezgahKodu], [nOncelikKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahSinifiKodu]
  ON [GUSTO00004].[TezgahSinifBaglanti] ([pTezgahSinifiKodu], [nOncelikKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO