CREATE TABLE [GUSTO00001].[KontrolPlan] (
...
CREATE INDEX [cKontrolAktiviteTipi]
  ON [GUSTO00001].[KontrolPlan] ([cKontrolAktiviteTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGirisDepoKodu]
  ON [GUSTO00001].[KontrolPlan] ([pGirisDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHedefDepoKodu]
  ON [GUSTO00001].[KontrolPlan] ([pHedefDepoKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUstKod]
  ON [GUSTO00001].[KontrolPlan] ([pUstKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[KontrolPlan] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00001].[KontrolPlan] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAd]
  ON [GUSTO00001].[KontrolPlan] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKod]
  ON [GUSTO00001].[KontrolPlan] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO