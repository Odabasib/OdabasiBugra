CREATE TABLE [GUSTO00004].[CSBordrosu] (
...
CREATE INDEX [KarsiHesapTarihKey]
  ON [GUSTO00004].[CSBordrosu] ([pKarsiKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaTarihKey]
  ON [GUSTO00004].[CSBordrosu] ([pSCKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihSeriKey]
  ON [GUSTO00004].[CSBordrosu] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TurSeriKey]
  ON [GUSTO00004].[CSBordrosu] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO