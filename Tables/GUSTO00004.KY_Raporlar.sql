CREATE TABLE [GUSTO00004].[KY_Raporlar] (
  [KY_Raporlar_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Raporlar_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00004].[KY_Raporlar] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO