CREATE TABLE [GUSTO00001].[PersonelBESBilgileri] (
...
CREATE INDEX [pPersonel_AktifKey]
  ON [GUSTO00001].[PersonelBESBilgileri] ([pPersonel], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSigortaAktifKey]
  ON [GUSTO00001].[PersonelBESBilgileri] ([pSigortaSirketi], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO