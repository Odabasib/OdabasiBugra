CREATE TABLE [GUSTO00001].[HarKontrolPlanKrktAnlz] (
...
CREATE INDEX [cHataTipi]
  ON [GUSTO00001].[HarKontrolPlanKrktAnlz] ([cHataTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00001].[HarKontrolPlanKrktAnlz] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00001].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00001].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO