CREATE TABLE [GUSTO00005].[PersonelAnketCevap] (
...
CREATE INDEX [BasvuruCevapKey]
  ON [GUSTO00005].[PersonelAnketCevap] ([pBasvuru], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelCevapKey]
  ON [GUSTO00005].[PersonelAnketCevap] ([pHesapKodu], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO