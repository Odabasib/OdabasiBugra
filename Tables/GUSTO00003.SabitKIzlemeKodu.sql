CREATE TABLE [GUSTO00003].[SabitKIzlemeKodu] (
...
CREATE INDEX [AdKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KisaAdKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [sKisaAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [KodKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBagliOlduguSKAyrintiKodu]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pBagliOlduguSKAyrintiKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDurumuKodKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [cStoktaVarMi], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKisaAdKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [pUstKod], [sKisaAdi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKey]
  ON [GUSTO00003].[SabitKIzlemeKodu] ([pSabitKKodu], [pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO