CREATE TABLE [GUSTO00003].[ASiparisIsEmriBaglanti] (
...
CREATE INDEX [pBaglayanBelge]
  ON [GUSTO00003].[ASiparisIsEmriBaglanti] ([pBaglayanBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriUrunler]
  ON [GUSTO00003].[ASiparisIsEmriBaglanti] ([pIsEmriUrunler], [pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO