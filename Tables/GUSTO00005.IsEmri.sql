CREATE TABLE [GUSTO00005].[IsEmri] (
...
CREATE INDEX [nLevel]
  ON [GUSTO00005].[IsEmri] ([nLevel])
  ON [PRIMARY]
GO

CREATE INDEX [pMRPBaslik]
  ON [GUSTO00005].[IsEmri] ([pMRPBaslik])
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciKodu]
  ON [GUSTO00005].[IsEmri] ([pUrunAgaciKodu])
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00005].[IsEmri] ([nIsEmriNo])
  ON [PRIMARY]
GO

CREATE INDEX [TarihSeriKey]
  ON [GUSTO00005].[IsEmri] ([dtIsEmriTarihi])
  ON [PRIMARY]
GO