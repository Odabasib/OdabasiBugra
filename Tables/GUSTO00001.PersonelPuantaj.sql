CREATE TABLE [GUSTO00001].[PersonelPuantaj] (
...
CREATE INDEX [PersIsYeri]
  ON [GUSTO00001].[PersonelPuantaj] ([pIsYeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelPuantajKey]
  ON [GUSTO00001].[PersonelPuantaj] ([pPersonel], [cMaasFark], [nYil], [nAy], [pIsYeri], [pTahakkukTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO