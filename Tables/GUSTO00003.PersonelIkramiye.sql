CREATE TABLE [GUSTO00003].[PersonelIkramiye] (
...
CREATE INDEX [PersonelYilAyKey]
  ON [GUSTO00003].[PersonelIkramiye] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemId]
  ON [GUSTO00003].[PersonelIkramiye] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00003].[PersonelIkramiye] ([pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO