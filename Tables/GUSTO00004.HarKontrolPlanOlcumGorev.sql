CREATE TABLE [GUSTO00004].[HarKontrolPlanOlcumGorev] (
...
CREATE INDEX [pGorevKodu]
  ON [GUSTO00004].[HarKontrolPlanOlcumGorev] ([pGorevKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00004].[HarKontrolPlanOlcumGorev] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00004].[HarKontrolPlanOlcumGorev] ([pPersonelKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO