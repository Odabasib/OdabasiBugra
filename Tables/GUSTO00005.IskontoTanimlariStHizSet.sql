CREATE TABLE [GUSTO00005].[IskontoTanimlariStHizSet] (
...
CREATE UNIQUE INDEX [IskontoTanimiStok]
  ON [GUSTO00005].[IskontoTanimlariStHizSet] ([pIskontoTanimi], [cStokHizmetSet], [pStokHizmetSetKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIskontoTanimi]
  ON [GUSTO00005].[IskontoTanimlariStHizSet] ([pIskontoTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO