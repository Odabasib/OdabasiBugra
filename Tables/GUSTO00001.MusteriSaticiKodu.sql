CREATE TABLE [GUSTO00001].[MusteriSaticiKodu] (
...
CREATE INDEX [MSAdKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSBayiKodKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSGrupKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([pGrupKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MSKodKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([sKod], [bAktif], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodAdKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodKodKey]
  ON [GUSTO00001].[MusteriSaticiKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO