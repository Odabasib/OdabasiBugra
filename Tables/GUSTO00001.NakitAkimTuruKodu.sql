CREATE TABLE [GUSTO00001].[NakitAkimTuruKodu] (
...
CREATE INDEX [NATGelirGiderKey]
  ON [GUSTO00001].[NakitAkimTuruKodu] ([cNakitAkimSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NATUstKodAdKey]
  ON [GUSTO00001].[NakitAkimTuruKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NATUstKodKey]
  ON [GUSTO00001].[NakitAkimTuruKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[NakitAkimTuruKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00001].[NakitAkimTuruKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO