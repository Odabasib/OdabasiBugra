CREATE TABLE [GUSTO00001].[AlinanCekHareket] (
  [AlinanCekHareket_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([AlinanCekHareket_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE UNIQUE INDEX [CekTarihKey]
  ON [GUSTO00001].[AlinanCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pCekBordrosu]
  ON [GUSTO00001].[AlinanCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[AlinanCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO