CREATE TABLE [GUSTO00005].[FIFOBaglanti] (
...
CREATE INDEX [pAlimHareketi]
  ON [GUSTO00005].[FIFOBaglanti] ([pAlimHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSatisHareketi]
  ON [GUSTO00005].[FIFOBaglanti] ([pSatisHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDepoCikisTarihKey]
  ON [GUSTO00005].[FIFOBaglanti] ([pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarihCikis], [nSiraCikis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDepoGirisTarihKey]
  ON [GUSTO00005].[FIFOBaglanti] ([pStokKodu], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarihGiris], [nSiraGiris])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO