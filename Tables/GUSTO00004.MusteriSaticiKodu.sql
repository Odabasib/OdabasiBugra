CREATE TABLE [GUSTO00004].[MusteriSaticiKodu] (
...
CREATE INDEX [MSAdKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSBayiKodKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSGrupKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([pGrupKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MSKodKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([sKod], [bAktif], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodAdKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodKodKey]
  ON [GUSTO00004].[MusteriSaticiKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO