CREATE TABLE [GUSTO00003].[IsEmriBirlBaglantiTabl] (
...
CREATE INDEX [BirlesmisUyeIsemriKey]
  ON [GUSTO00003].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [BirlesmisUyeIsemriRzvYeriKey]
  ON [GUSTO00003].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri], [pUyeIsEmri], [pRezervasyon], [pBirlesmisRzvYeriBelge], [pUyeRzvYeriBelge])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBirlesmisIsEmri]
  ON [GUSTO00003].[IsEmriBirlBaglantiTabl] ([pBirlesmisIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUyeIsEmri]
  ON [GUSTO00003].[IsEmriBirlBaglantiTabl] ([pUyeIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO