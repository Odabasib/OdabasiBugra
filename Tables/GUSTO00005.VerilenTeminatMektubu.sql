CREATE TABLE [GUSTO00005].[VerilenTeminatMektubu] (
...
CREATE INDEX [BankaNo]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([pBankaHesabi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [CariNo]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDIade]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([pIslemIDIade])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemIDVerilis]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([pIslemIDVerilis])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([dtMektupTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Vade]
  ON [GUSTO00005].[VerilenTeminatMektubu] ([dtVadesi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO