...
CREATE INDEX [pMRPBaslik]
  ON [GUSTO00001].[Talep] ([pMRPBaslik])
  ON [PRIMARY]
GO

CREATE INDEX [StokKey]
  ON [GUSTO00001].[Talep] ([pStok], [pIzlemeKodu])
  ON [PRIMARY]
GO

CREATE INDEX [TalepSeriNoKey]
  ON [GUSTO00001].[Talep] ([lNo])
  ON [PRIMARY]
GO

CREATE INDEX [TalepTarihKey]
  ON [GUSTO00001].[Talep] ([dtTarih])
  ON [PRIMARY]
GO

CREATE INDEX [TopluTalepSeriKey]
  ON [GUSTO00001].[Talep] ([pTopluTalep])
  ON [PRIMARY]
GO