CREATE TABLE [GUSTO00001].[VerilenCekHareket] (
...
CREATE INDEX [pCekBordrosu]
  ON [GUSTO00001].[VerilenCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00001].[VerilenCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VCHSiraKey]
  ON [GUSTO00001].[VerilenCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO