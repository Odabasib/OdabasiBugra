CREATE TABLE [GUSTO00001].[DepoHareketEmri] (
...
CREATE INDEX [Baslik]
  ON [GUSTO00001].[DepoHareketEmri] ([pBaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Depo]
  ON [GUSTO00001].[DepoHareketEmri] ([pDepo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00001].[DepoHareketEmri] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Sira]
  ON [GUSTO00001].[DepoHareketEmri] ([nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Stok]
  ON [GUSTO00001].[DepoHareketEmri] ([pStokKodu], [pIzlemeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00001].[DepoHareketEmri] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO