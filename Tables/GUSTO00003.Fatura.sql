CREATE TABLE [GUSTO00003].[Fatura] (
...
CREATE INDEX [Cari]
  ON [GUSTO00003].[Fatura] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaNo]
  ON [GUSTO00003].[Fatura] ([lFaturaNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FaturaTarih]
  ON [GUSTO00003].[Fatura] ([dtFaturaTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FCariTur]
  ON [GUSTO00003].[Fatura] ([nEFaturaDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemId]
  ON [GUSTO00003].[Fatura] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemIdMaliye]
  ON [GUSTO00003].[Fatura] ([pIslemIDMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarihi]
  ON [GUSTO00003].[Fatura] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO