CREATE TABLE [GUSTO00005].[PersonelBolumVardiya] (
...
CREATE INDEX [pBolumKodu]
  ON [GUSTO00005].[PersonelBolumVardiya] ([pBolumKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsMerkeziKodu]
  ON [GUSTO00005].[PersonelBolumVardiya] ([pIsMerkeziKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00005].[PersonelBolumVardiya] ([pPersonelKodu], [dtBasTarih], [nKayitTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahKodu]
  ON [GUSTO00005].[PersonelBolumVardiya] ([pTezgahKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO