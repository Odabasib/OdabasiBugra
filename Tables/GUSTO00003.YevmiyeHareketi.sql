CREATE TABLE [GUSTO00003].[YevmiyeHareketi] (
...
CREATE INDEX [Donem]
  ON [GUSTO00003].[YevmiyeHareketi] ([pDonem])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Fis]
  ON [GUSTO00003].[YevmiyeHareketi] ([pYevmiyeFisi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [FisNo]
  ON [GUSTO00003].[YevmiyeHareketi] ([lFisNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HesapDonemTar]
  ON [GUSTO00003].[YevmiyeHareketi] ([pHesapKodu], [pDonem], [dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HesapKodu]
  ON [GUSTO00003].[YevmiyeHareketi] ([pHesapKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemID]
  ON [GUSTO00003].[YevmiyeHareketi] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[YevmiyeHareketi] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO