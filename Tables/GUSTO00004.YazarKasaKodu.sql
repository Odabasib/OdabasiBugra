CREATE TABLE [GUSTO00004].[YazarKasaKodu] (
...
CREATE INDEX [nYazarKasaTur]
  ON [GUSTO00004].[YazarKasaKodu] ([nYazarKasaTur])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00004].[YazarKasaKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00004].[YazarKasaKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyYazarKasa]
  ON [GUSTO00004].[YazarKasaKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyYazarKasa]
  ON [GUSTO00004].[YazarKasaKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO