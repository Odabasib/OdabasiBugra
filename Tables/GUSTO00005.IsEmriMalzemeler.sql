CREATE TABLE [GUSTO00005].[IsEmriMalzemeler] (
...
CREATE INDEX [bYariMamul]
  ON [GUSTO00005].[IsEmriMalzemeler] ([bYariMamul])
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00005].[IsEmriMalzemeler] ([pIsemri], [pIsEmriUrunler])
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[IsEmriMalzemeler] ([pStokKodu])
  ON [PRIMARY]
GO