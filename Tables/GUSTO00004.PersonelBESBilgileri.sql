CREATE TABLE [GUSTO00004].[PersonelBESBilgileri] (
...
CREATE INDEX [pPersonel_AktifKey]
  ON [GUSTO00004].[PersonelBESBilgileri] ([pPersonel], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSigortaAktifKey]
  ON [GUSTO00004].[PersonelBESBilgileri] ([pSigortaSirketi], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO