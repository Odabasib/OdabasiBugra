CREATE TABLE [GUSTO00005].[VerSipSatirIskontolari] (
  [VerSipSatirIskontolari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([VerSipSatirIskontolari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [HareketSiraKey]
  ON [GUSTO00005].[VerSipSatirIskontolari] ([pSatir], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO