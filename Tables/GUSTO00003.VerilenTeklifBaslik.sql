CREATE TABLE [GUSTO00003].[VerilenTeklifBaslik] (
...
CREATE INDEX [CariSeriNoKey]
  ON [GUSTO00003].[VerilenTeklifBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OpsiyonTarKey]
  ON [GUSTO00003].[VerilenTeklifBaslik] ([dtOpsiyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelSeriNoKey]
  ON [GUSTO00003].[VerilenTeklifBaslik] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00003].[VerilenTeklifBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00003].[VerilenTeklifBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO