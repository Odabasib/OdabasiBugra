CREATE TABLE [GUSTO00001].[MSDigerKodu] (
...
CREATE INDEX [MSDUstKodAdKey]
  ON [GUSTO00001].[MSDigerKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSDUstKodKodKey]
  ON [GUSTO00001].[MSDigerKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00001].[MSDigerKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00001].[MSDigerKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO