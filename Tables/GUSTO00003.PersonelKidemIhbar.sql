CREATE TABLE [GUSTO00003].[PersonelKidemIhbar] (
...
CREATE UNIQUE INDEX [pIslemId]
  ON [GUSTO00003].[PersonelKidemIhbar] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonel]
  ON [GUSTO00003].[PersonelKidemIhbar] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriKey]
  ON [GUSTO00003].[PersonelKidemIhbar] ([lSeriNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO