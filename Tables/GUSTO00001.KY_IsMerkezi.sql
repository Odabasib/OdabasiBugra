CREATE TABLE [GUSTO00001].[KY_IsMerkezi] (
  [KY_IsMerkezi_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_IsMerkezi_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00001].[KY_IsMerkezi] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO