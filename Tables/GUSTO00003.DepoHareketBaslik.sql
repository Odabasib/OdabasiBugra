CREATE TABLE [GUSTO00003].[DepoHareketBaslik] (
...
CREATE INDEX [Depo]
  ON [GUSTO00003].[DepoHareketBaslik] ([pDepoCikis], [pDepoGiris])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00003].[DepoHareketBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00003].[DepoHareketBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO