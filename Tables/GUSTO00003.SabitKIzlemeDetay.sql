CREATE TABLE [GUSTO00003].[SabitKIzlemeDetay] (
...
CREATE INDEX [pAlimHareketi]
  ON [GUSTO00003].[SabitKIzlemeDetay] ([pAlimHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKymTurleri]
  ON [GUSTO00003].[SabitKIzlemeDetay] ([pSabitKymTurleri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00003].[SabitKIzlemeDetay] ([sBarkod1Birim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO