CREATE TABLE [GUSTO00004].[IsEmriGerceklesenOpr] (
...
CREATE INDEX [dtIslemBitisTarihi]
  ON [GUSTO00004].[IsEmriGerceklesenOpr] ([dtIslemBitisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OperasyonSeri]
  ON [GUSTO00004].[IsEmriGerceklesenOpr] ([pIsEmriOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemri]
  ON [GUSTO00004].[IsEmriGerceklesenOpr] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[IsEmriGerceklesenOpr] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00004].[IsEmriGerceklesenOpr] ([nNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO