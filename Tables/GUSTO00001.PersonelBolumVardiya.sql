CREATE TABLE [GUSTO00001].[PersonelBolumVardiya] (
...
CREATE INDEX [pBolumKodu]
  ON [GUSTO00001].[PersonelBolumVardiya] ([pBolumKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsMerkeziKodu]
  ON [GUSTO00001].[PersonelBolumVardiya] ([pIsMerkeziKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00001].[PersonelBolumVardiya] ([pPersonelKodu], [dtBasTarih], [nKayitTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTezgahKodu]
  ON [GUSTO00001].[PersonelBolumVardiya] ([pTezgahKodu], [dtBasTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO