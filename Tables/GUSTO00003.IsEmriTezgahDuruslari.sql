CREATE TABLE [GUSTO00003].[IsEmriTezgahDuruslari] (
...
CREATE INDEX [pIsemri]
  ON [GUSTO00003].[IsEmriTezgahDuruslari] ([pIsemri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00003].[IsEmriTezgahDuruslari] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO