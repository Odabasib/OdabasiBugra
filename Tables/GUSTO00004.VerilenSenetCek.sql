CREATE TABLE [GUSTO00004].[VerilenSenetCek] (
...
CREATE INDEX [AlacakliVadeKey]
  ON [GUSTO00004].[VerilenSenetCek] ([pAlacakliKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVadeTarihi]
  ON [GUSTO00004].[VerilenSenetCek] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [dtVerilisTarihi]
  ON [GUSTO00004].[VerilenSenetCek] ([dtVerilisTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [KasaVerilisTarKey]
  ON [GUSTO00004].[VerilenSenetCek] ([pCikisKasaKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO