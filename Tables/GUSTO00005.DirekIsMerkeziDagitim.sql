CREATE TABLE [GUSTO00005].[DirekIsMerkeziDagitim] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[DirekIsMerkeziDagitim] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [VerenIsMerkeziYilAy]
  ON [GUSTO00005].[DirekIsMerkeziDagitim] ([pVerenIsMerkezi], [nYil], [nAy], [pStokKodu], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO