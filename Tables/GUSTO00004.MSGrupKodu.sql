CREATE TABLE [GUSTO00004].[MSGrupKodu] (
...
CREATE INDEX [MSGUstKodAdKey]
  ON [GUSTO00004].[MSGrupKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSGUstKodKodKey]
  ON [GUSTO00004].[MSGrupKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00004].[MSGrupKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00004].[MSGrupKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO