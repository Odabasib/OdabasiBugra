CREATE TABLE [GUSTO00003].[IsBasvurulari] (
...
CREATE INDEX [AdSoyadDogumTarihiKey]
  ON [GUSTO00003].[IsBasvurulari] ([sAdi], [sSoyadi], [dtDogumTarihi], [sAnneKizlikSoyadi], [sSeri], [nNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [DegerlendirmeGorevTanimi]
  ON [GUSTO00003].[IsBasvurulari] ([pDegerlendirme], [pGorevTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO