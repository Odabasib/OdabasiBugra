CREATE TABLE [GUSTO00003].[GelirGiderTuruKodu] (
...
CREATE INDEX [GGTGelirGiderKey]
  ON [GUSTO00003].[GelirGiderTuruKodu] ([cGelirGiderSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodAdKey]
  ON [GUSTO00003].[GelirGiderTuruKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GGTUstKodKey]
  ON [GUSTO00003].[GelirGiderTuruKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00003].[GelirGiderTuruKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00003].[GelirGiderTuruKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO