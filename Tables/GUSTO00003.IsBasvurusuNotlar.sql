CREATE TABLE [GUSTO00003].[IsBasvurusuNotlar] (
...
CREATE INDEX [OwnerIDTanimIDKey]
  ON [GUSTO00003].[IsBasvurusuNotlar] ([pOwnerID], [pTanimID], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelDegerlendimeKey]
  ON [GUSTO00003].[IsBasvurusuNotlar] ([pTanimID], [pDegerlendirme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO