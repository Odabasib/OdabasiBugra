CREATE TABLE [GUSTO00003].[HarKontrolPlanKrktAnlz] (
...
CREATE INDEX [cHataTipi]
  ON [GUSTO00003].[HarKontrolPlanKrktAnlz] ([cHataTipi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00003].[HarKontrolPlanKrktAnlz] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00003].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanOlcumSonuc]
  ON [GUSTO00003].[HarKontrolPlanKrktAnlz] ([pHarKontrolPlanOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO