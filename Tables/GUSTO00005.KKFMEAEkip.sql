CREATE TABLE [GUSTO00005].[KKFMEAEkip] (
...
CREATE INDEX [pBolum]
  ON [GUSTO00005].[KKFMEAEkip] ([pBolum])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pGorev]
  ON [GUSTO00005].[KKFMEAEkip] ([pGorev])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKKFMEABaslik]
  ON [GUSTO00005].[KKFMEAEkip] ([pKKFMEABaslik])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pPersonelKodu]
  ON [GUSTO00005].[KKFMEAEkip] ([pPersonelKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO