CREATE TABLE [GUSTO00005].[KY_Hizmet] (
  [KY_Hizmet_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Hizmet_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00005].[KY_Hizmet] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO