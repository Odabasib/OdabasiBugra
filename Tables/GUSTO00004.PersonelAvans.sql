CREATE TABLE [GUSTO00004].[PersonelAvans] (
...
CREATE UNIQUE INDEX [PersonelYilAyKey]
  ON [GUSTO00004].[PersonelAvans] ([pPersonel], [nYil], [nAy], [pIkramiyeTanimi], [pIsyeri], [nAvansTuru], [pAvansTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00004].[PersonelAvans] ([nYil], [nAy], [pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO