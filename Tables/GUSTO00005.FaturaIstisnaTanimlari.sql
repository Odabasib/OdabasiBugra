CREATE TABLE [GUSTO00005].[FaturaIstisnaTanimlari] (
...
CREATE UNIQUE INDEX [AdTur]
  ON [GUSTO00005].[FaturaIstisnaTanimlari] ([sAd], [nIstisnaTuru], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [EvrenselKodTur]
  ON [GUSTO00005].[FaturaIstisnaTanimlari] ([sEvrenselKodu], [nIstisnaTuru])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO