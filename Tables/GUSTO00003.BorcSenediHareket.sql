CREATE TABLE [GUSTO00003].[BorcSenediHareket] (
...
CREATE UNIQUE INDEX [HareketSirasi]
  ON [GUSTO00003].[BorcSenediHareket] ([pSenet], [nSiraNo], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [HareketTipi]
  ON [GUSTO00003].[BorcSenediHareket] ([pSenet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00003].[BorcSenediHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSenetBordrosu]
  ON [GUSTO00003].[BorcSenediHareket] ([pSenetBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO