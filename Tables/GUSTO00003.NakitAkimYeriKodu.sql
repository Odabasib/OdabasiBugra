CREATE TABLE [GUSTO00003].[NakitAkimYeriKodu] (
...
CREATE INDEX [NAYGelirGiderKey]
  ON [GUSTO00003].[NakitAkimYeriKodu] ([cNakitAkimSekli], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NAYUstKodAdKey]
  ON [GUSTO00003].[NakitAkimYeriKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [NAYUstKodKey]
  ON [GUSTO00003].[NakitAkimYeriKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00003].[NakitAkimYeriKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00003].[NakitAkimYeriKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO