CREATE TABLE [GUSTO00004].[Malzemeler] (
...
CREATE INDEX [pStokKodu]
  ON [GUSTO00004].[Malzemeler] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciKodu]
  ON [GUSTO00004].[Malzemeler] ([pUrunAgaciKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pUrunAgaciUrunler]
  ON [GUSTO00004].[Malzemeler] ([pUrunAgaciKodu], [pUrunler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO