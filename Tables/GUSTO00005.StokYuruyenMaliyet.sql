CREATE TABLE [GUSTO00005].[StokYuruyenMaliyet] (
...
CREATE INDEX [StokDepoTarihKey]
  ON [GUSTO00005].[StokYuruyenMaliyet] ([pStokKarti], [pIzlemeKodu], [pDepoMaliyetKodu], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokHareketKey]
  ON [GUSTO00005].[StokYuruyenMaliyet] ([pStokHareket], [pIzlemeKodu], [pDepoMaliyetKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO