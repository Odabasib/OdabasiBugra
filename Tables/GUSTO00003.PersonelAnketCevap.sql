CREATE TABLE [GUSTO00003].[PersonelAnketCevap] (
...
CREATE INDEX [BasvuruCevapKey]
  ON [GUSTO00003].[PersonelAnketCevap] ([pBasvuru], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelCevapKey]
  ON [GUSTO00003].[PersonelAnketCevap] ([pHesapKodu], [pAnket], [pSoru], [pSoruSecenegi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO