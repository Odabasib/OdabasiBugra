CREATE TABLE [GUSTO00004].[StokHareketBaslik] (
...
CREATE INDEX [CariKodu]
  ON [GUSTO00004].[StokHareketBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [EIrsaliyeCariTur]
  ON [GUSTO00004].[StokHareketBaslik] ([nEIrsaliyeDurumu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Fatura]
  ON [GUSTO00004].[StokHareketBaslik] ([pFatura])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemID]
  ON [GUSTO00004].[StokHareketBaslik] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNo]
  ON [GUSTO00004].[StokHareketBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [Tarih]
  ON [GUSTO00004].[StokHareketBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO