CREATE TABLE [GUSTO00005].[MSDigerKodu] (
...
CREATE INDEX [MSDUstKodAdKey]
  ON [GUSTO00005].[MSDigerKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSDUstKodKodKey]
  ON [GUSTO00005].[MSDigerKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sAd]
  ON [GUSTO00005].[MSDigerKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sKod]
  ON [GUSTO00005].[MSDigerKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO