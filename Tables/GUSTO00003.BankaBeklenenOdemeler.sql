CREATE TABLE [GUSTO00003].[BankaBeklenenOdemeler] (
...
CREATE INDEX [BankaTarihSira]
  ON [GUSTO00003].[BankaBeklenenOdemeler] ([pBankaHesabi], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekTarihBankaSira]
  ON [GUSTO00003].[BankaBeklenenOdemeler] ([pGerceklesenHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pRepoHareketi]
  ON [GUSTO00003].[BankaBeklenenOdemeler] ([pRepoHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO