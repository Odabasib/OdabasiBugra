CREATE TABLE [GUSTO00001].[KY_Muhasebe] (
  [KY_Muhasebe_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([KY_Muhasebe_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [KartYetki]
  ON [GUSTO00001].[KY_Muhasebe] ([pKodAd], [pKullanici])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO