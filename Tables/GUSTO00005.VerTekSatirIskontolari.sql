CREATE TABLE [GUSTO00005].[VerTekSatirIskontolari] (
  [VerTekSatirIskontolari_rowid] [int] IDENTITY,
  ...
  PRIMARY KEY CLUSTERED ([VerTekSatirIskontolari_rowid]) WITH (FILLFACTOR = 90)
)
ON [PRIMARY]
GO

CREATE INDEX [HareketSiraKey]
  ON [GUSTO00005].[VerTekSatirIskontolari] ([pSatir], [dSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO