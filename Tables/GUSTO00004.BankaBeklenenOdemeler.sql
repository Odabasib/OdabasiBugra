CREATE TABLE [GUSTO00004].[BankaBeklenenOdemeler] (
...
CREATE INDEX [BankaTarihSira]
  ON [GUSTO00004].[BankaBeklenenOdemeler] ([pBankaHesabi], [dtTarih], [nSira])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [GercekTarihBankaSira]
  ON [GUSTO00004].[BankaBeklenenOdemeler] ([pGerceklesenHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pRepoHareketi]
  ON [GUSTO00004].[BankaBeklenenOdemeler] ([pRepoHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO