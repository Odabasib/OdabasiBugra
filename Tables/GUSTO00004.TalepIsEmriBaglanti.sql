CREATE TABLE [GUSTO00004].[TalepIsEmriBaglanti] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00004].[TalepIsEmriBaglanti] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriMalzemeler]
  ON [GUSTO00004].[TalepIsEmriBaglanti] ([pIsEmriMalzemeler])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pTalep]
  ON [GUSTO00004].[TalepIsEmriBaglanti] ([pTalep])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO