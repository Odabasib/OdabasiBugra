CREATE TABLE [GUSTO00003].[HarKontrolPlanKrkt] (
...
CREATE INDEX [pHarKontrolPlan]
  ON [GUSTO00003].[HarKontrolPlanKrkt] ([pHarKontrolPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00003].[HarKontrolPlanKrkt] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolPlanKrkt]
  ON [GUSTO00003].[HarKontrolPlanKrkt] ([pKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO