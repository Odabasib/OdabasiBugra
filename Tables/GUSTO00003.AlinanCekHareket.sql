CREATE TABLE [GUSTO00003].[AlinanCekHareket] (
...
CREATE UNIQUE INDEX [CekTarihKey]
  ON [GUSTO00003].[AlinanCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pCekBordrosu]
  ON [GUSTO00003].[AlinanCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00003].[AlinanCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO