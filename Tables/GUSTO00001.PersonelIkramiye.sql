CREATE TABLE [GUSTO00001].[PersonelIkramiye] (
...
CREATE INDEX [PersonelYilAyKey]
  ON [GUSTO00001].[PersonelIkramiye] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemId]
  ON [GUSTO00001].[PersonelIkramiye] ([pIslemId])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00001].[PersonelIkramiye] ([pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO