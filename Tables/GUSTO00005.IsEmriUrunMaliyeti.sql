CREATE TABLE [GUSTO00005].[IsEmriUrunMaliyeti] (
...
CREATE INDEX [dtTarih]
  ON [GUSTO00005].[IsEmriUrunMaliyeti] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriGercekMaliyet]
  ON [GUSTO00005].[IsEmriUrunMaliyeti] ([pIsEmriGercekMaliyet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsEmriUretilenUrun]
  ON [GUSTO00005].[IsEmriUrunMaliyeti] ([pIsEmriUretilenUrun])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsMerkezi]
  ON [GUSTO00005].[IsEmriUrunMaliyeti] ([pIsMerkezi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[IsEmriUrunMaliyeti] ([pStokKodu], [cStokHizmet])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO