CREATE TABLE [GUSTO00003].[PersonelBESBilgileri] (
...
CREATE INDEX [pPersonel_AktifKey]
  ON [GUSTO00003].[PersonelBESBilgileri] ([pPersonel], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSigortaAktifKey]
  ON [GUSTO00003].[PersonelBESBilgileri] ([pSigortaSirketi], [dtBaslangicTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO