CREATE TABLE [GUSTO00005].[AlinanTeklifBaslik] (
...
CREATE INDEX [CariOpsiyonTarKey]
  ON [GUSTO00005].[AlinanTeklifBaslik] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [PersonelOpsiyonTarKey]
  ON [GUSTO00005].[AlinanTeklifBaslik] ([pPersonel])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [SeriNoKey]
  ON [GUSTO00005].[AlinanTeklifBaslik] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [TarihKey]
  ON [GUSTO00005].[AlinanTeklifBaslik] ([dtTarih])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO