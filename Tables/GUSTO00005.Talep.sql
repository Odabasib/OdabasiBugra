...
CREATE INDEX [pMRPBaslik]
  ON [GUSTO00005].[Talep] ([pMRPBaslik])
  ON [PRIMARY]
GO

CREATE INDEX [StokKey]
  ON [GUSTO00005].[Talep] ([pStok], [pIzlemeKodu])
  ON [PRIMARY]
GO

CREATE INDEX [TalepSeriNoKey]
  ON [GUSTO00005].[Talep] ([lNo])
  ON [PRIMARY]
GO

CREATE INDEX [TalepTarihKey]
  ON [GUSTO00005].[Talep] ([dtTarih])
  ON [PRIMARY]
GO

CREATE INDEX [TopluTalepSeriKey]
  ON [GUSTO00005].[Talep] ([pTopluTalep])
  ON [PRIMARY]
GO