CREATE TABLE [GUSTO00003].[PersonelAvans] (
...
CREATE UNIQUE INDEX [PersonelYilAyKey]
  ON [GUSTO00003].[PersonelAvans] ([pPersonel], [nYil], [nAy], [pIkramiyeTanimi], [pIsyeri], [nAvansTuru], [pAvansTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [YilAyKey]
  ON [GUSTO00003].[PersonelAvans] ([nYil], [nAy], [pIkramiyeTanimi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO