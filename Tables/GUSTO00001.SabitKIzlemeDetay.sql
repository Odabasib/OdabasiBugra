CREATE TABLE [GUSTO00001].[SabitKIzlemeDetay] (
...
CREATE INDEX [pAlimHareketi]
  ON [GUSTO00001].[SabitKIzlemeDetay] ([pAlimHareketi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pSabitKymTurleri]
  ON [GUSTO00001].[SabitKIzlemeDetay] ([pSabitKymTurleri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sBarkod1Birim]
  ON [GUSTO00001].[SabitKIzlemeDetay] ([sBarkod1Birim])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO