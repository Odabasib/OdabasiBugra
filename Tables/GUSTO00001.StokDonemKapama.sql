CREATE TABLE [GUSTO00001].[StokDonemKapama] (
...
CREATE INDEX [StokDonem]
  ON [GUSTO00001].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [StokDonemAy]
  ON [GUSTO00001].[StokDonemKapama] ([pStokKodu], [pDepoMaliyetKodu], [pStokDonemi], [nAy])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO