CREATE TABLE [GUSTO00004].[LEF_EFATURA_ARSIV] (
...
CREATE INDEX [IND_LEFGIDEN]
  ON [GUSTO00004].[LEF_EFATURA_ARSIV] ([PFATURA], [PCARIID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [IND_LEFGIDENETTN]
  ON [GUSTO00004].[LEF_EFATURA_ARSIV] ([ETTN])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IND_LEFGIDENNO]
  ON [GUSTO00004].[LEF_EFATURA_ARSIV] ([EFATURANO])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO