CREATE TABLE [GUSTO00005].[FasonHareket] (
...
CREATE INDEX [pIsEmri]
  ON [GUSTO00005].[FasonHareket] ([pIsEmri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIsemriGerceklesenOperasyon]
  ON [GUSTO00005].[FasonHareket] ([pIsemriGerceklesenOperasyon])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pStokKodu]
  ON [GUSTO00005].[FasonHareket] ([pStokKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO