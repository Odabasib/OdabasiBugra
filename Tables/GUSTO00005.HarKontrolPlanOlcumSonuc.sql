CREATE TABLE [GUSTO00005].[HarKontrolPlanOlcumSonuc] (
...
CREATE INDEX [cOlcumSonuc]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([cOlcumSonuc])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [cOrneklemeNo]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([cOrneklemeNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [lNo]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([lNo])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pVardiya]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([pVardiya])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [sSeri]
  ON [GUSTO00005].[HarKontrolPlanOlcumSonuc] ([sSeri])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO