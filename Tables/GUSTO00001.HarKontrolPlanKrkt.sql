CREATE TABLE [GUSTO00001].[HarKontrolPlanKrkt] (
...
CREATE INDEX [pHarKontrolPlan]
  ON [GUSTO00001].[HarKontrolPlanKrkt] ([pHarKontrolPlan])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolKrkt]
  ON [GUSTO00001].[HarKontrolPlanKrkt] ([pKontrolKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pKontrolPlanKrkt]
  ON [GUSTO00001].[HarKontrolPlanKrkt] ([pKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO