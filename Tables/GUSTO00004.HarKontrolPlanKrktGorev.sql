CREATE TABLE [GUSTO00004].[HarKontrolPlanKrktGorev] (
...
CREATE INDEX [pGorevKodu]
  ON [GUSTO00004].[HarKontrolPlanKrktGorev] ([pGorevKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pHarKontrolPlanKrkt]
  ON [GUSTO00004].[HarKontrolPlanKrktGorev] ([pHarKontrolPlanKrkt])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO