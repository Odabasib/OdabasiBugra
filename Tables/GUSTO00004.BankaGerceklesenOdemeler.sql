CREATE TABLE [GUSTO00004].[BankaGerceklesenOdemeler] (
...
CREATE INDEX [pBankaHareket]
  ON [GUSTO00004].[BankaGerceklesenOdemeler] ([pBankaHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pBankaOdeme]
  ON [GUSTO00004].[BankaGerceklesenOdemeler] ([pBankaOdeme])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO