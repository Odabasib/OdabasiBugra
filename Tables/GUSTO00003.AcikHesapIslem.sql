CREATE TABLE [GUSTO00003].[AcikHesapIslem] (
...
CREATE INDEX [Cari]
  ON [GUSTO00003].[AcikHesapIslem] ([pCari])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [IslemTarih]
  ON [GUSTO00003].[AcikHesapIslem] ([dtIslemTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [OlusturanHar]
  ON [GUSTO00003].[AcikHesapIslem] ([pOlusturanHareket])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [VadeTarih]
  ON [GUSTO00003].[AcikHesapIslem] ([dtVadeTarihi])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO