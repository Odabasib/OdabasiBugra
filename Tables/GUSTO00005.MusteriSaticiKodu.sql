CREATE TABLE [GUSTO00005].[MusteriSaticiKodu] (
...
CREATE INDEX [MSAdKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSBayiKodKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSGrupKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([pGrupKodu], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [MSKodKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([sKod], [bAktif], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodAdKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [MSUstKodKodKey]
  ON [GUSTO00005].[MusteriSaticiKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO