CREATE TABLE [GUSTO00001].[SabitKYerKodu] (
...
CREATE INDEX [sAd]
  ON [GUSTO00001].[SabitKYerKodu] ([sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE UNIQUE INDEX [sKod]
  ON [GUSTO00001].[SabitKYerKodu] ([sKod], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodAdKeyDepo]
  ON [GUSTO00001].[SabitKYerKodu] ([pUstKod], [sAd])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [UstKodKodKeyDepo]
  ON [GUSTO00001].[SabitKYerKodu] ([pUstKod], [sKod])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO