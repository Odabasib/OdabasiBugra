CREATE TABLE [GUSTO00004].[AlinanCekHareket] (
...
CREATE UNIQUE INDEX [CekTarihKey]
  ON [GUSTO00004].[AlinanCekHareket] ([pCek], [nSira], [SubeKodu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pCekBordrosu]
  ON [GUSTO00004].[AlinanCekHareket] ([pCekBordrosu])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO

CREATE INDEX [pIslemID]
  ON [GUSTO00004].[AlinanCekHareket] ([pIslemID])
  WITH (FILLFACTOR = 90)
  ON [PRIMARY]
GO