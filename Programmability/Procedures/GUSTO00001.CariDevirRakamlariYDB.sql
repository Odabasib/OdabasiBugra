...
GO
create PROCEDURE [GUSTO00001].[CariDevirRakamlariYDB]
...
SET NOCOUNT ON;
       ...
       begin
		...
		values(@MusteriSaticiKodu_rowid,'20180101',51,@ldTutar,'B','20180101',1,GETDATE(),@ldTutarDoviz)
		...
		values('C',@MusteriSaticiKodu_rowid,'20180101','B',51,@CariHareket_Rowid,@ldTutar,@ldTutar,@pHareketDoviz,'H','20180101',@ldTutarDoviz,@ldTutarDoviz)

		insert into Gusto00001.OdemePlani (dtTarih,nIslemTuru,ldToplamTutar)
		values ('20180101',11,@ldTutar)

		update Gusto00001.MusteriSaticiDetayi set ldDevredenBorc = @ldTutar , dtBorcDevirVadeTarihi = '20180101' ,ldDevredenDovizBorc=@ldTutarDoviz where MusteriSaticiDetayi_rowid = @MusteriSaticiDetayi_rowid
...
begin
		insert into Gusto.DevirLogYD (Carikod,ldTutar,ldTutarDoviz,cBorcAlacak) values (@sKod,@ldTutar,@ldTutarDoviz,'B')
