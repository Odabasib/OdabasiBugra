...
GO
CREATE PROCEDURE [GUSTO00001].[CariDevirRakamlariA]
...
SET NOCOUNT ON;
	  ...
	  set @ldTutar = (select replace(@ldTutar,',','.') )
       ...
       begin
		...
		values(@MusteriSaticiKodu_rowid,'20180101',51,@ldTutar,'A','20180101',1,GETDATE())
		...
		values('C',@MusteriSaticiKodu_rowid,'20180101','A',51,@CariHareket_Rowid,@ldTutar,@ldTutar,0,'H','20180101')

		insert into Gusto00001.OdemePlani (dtTarih,nIslemTuru,ldToplamTutar )
		values ('20180101',11,@ldTutar)

		update Gusto00001.MusteriSaticiDetayi set ldDevredenAlacak = @ldTutar , dtAlacakDevirVadeTarihi = '20180101' where MusteriSaticiDetayi_rowid = @MusteriSaticiDetayi_rowid
